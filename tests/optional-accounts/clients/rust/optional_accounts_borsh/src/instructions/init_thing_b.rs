...
pub struct InitThingBAccounts {
    pub payer: naclac_client::Address,
    pub thing_b: naclac_client::Address,
    pub system_program: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_init_thing_b<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitThingBAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![121, 127, 31, 205, 186, 210, 105, 51];
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.thing_b, is_signer: false, is_writable: true }, "thing_b")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct InitThingBCpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub thing_b: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct InitThingBCpiCall<'a> {
    pub accounts: InitThingBCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitThingBCpi<'info> {
    fn init_thing_b<'a>(
        &self,
        accounts: InitThingBCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_thing_b_with_remaining_accounts(InitThingBCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_thing_b_with_remaining_accounts<'a>(
        &self,
        call: InitThingBCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitThingBCpi<'info> for crate::sdk_core_cpi::Program<crate::OptionalAccountsBorsh> {
    fn init_thing_b_with_remaining_accounts<'a>(
        &self,
        call: InitThingBCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitThingBCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[121, 127, 31, 205, 186, 210, 105, 51]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.thing_b.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.thing_b));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.thing_b.address(), false),

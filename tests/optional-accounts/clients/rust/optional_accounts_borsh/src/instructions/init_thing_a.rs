...
pub struct InitThingAAccounts {
    pub payer: naclac_client::Address,
    pub thing_a: naclac_client::Address,
    pub system_program: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_init_thing_a<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitThingAAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![69, 7, 51, 52, 226, 223, 126, 15];
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.thing_a, is_signer: false, is_writable: true }, "thing_a")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct InitThingACpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub thing_a: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct InitThingACpiCall<'a> {
    pub accounts: InitThingACpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitThingACpi<'info> {
    fn init_thing_a<'a>(
        &self,
        accounts: InitThingACpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_thing_a_with_remaining_accounts(InitThingACpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_thing_a_with_remaining_accounts<'a>(
        &self,
        call: InitThingACpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitThingACpi<'info> for crate::sdk_core_cpi::Program<crate::OptionalAccountsBorsh> {
    fn init_thing_a_with_remaining_accounts<'a>(
        &self,
        call: InitThingACpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitThingACpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[69, 7, 51, 52, 226, 223, 126, 15]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.thing_a.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.thing_a));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.thing_a.address(), false),

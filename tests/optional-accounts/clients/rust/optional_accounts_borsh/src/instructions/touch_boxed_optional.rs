...
pub struct TouchBoxedOptionalAccounts {
    pub thing: Option<naclac_client::Address>,
}

#[cfg(feature = "offchain")]
pub fn build_touch_boxed_optional<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: TouchBoxedOptionalAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![44, 5, 78, 189, 42, 214, 82, 212];
...
#[cfg(feature = "cpi")]
pub struct TouchBoxedOptionalCpiAccounts<'a> {
    pub thing: Option<crate::sdk_core_cpi::CpiHandleMut<'a>>,
}

#[cfg(feature = "cpi")]
pub struct TouchBoxedOptionalCpiCall<'a> {
    pub accounts: TouchBoxedOptionalCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait TouchBoxedOptionalCpi<'info> {
    fn touch_boxed_optional<'a>(
        &self,
        accounts: TouchBoxedOptionalCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.touch_boxed_optional_with_remaining_accounts(TouchBoxedOptionalCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn touch_boxed_optional_signed<'a>(
        &self,
        accounts: TouchBoxedOptionalCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn touch_boxed_optional_with_remaining_accounts<'a>(
        &self,
        call: TouchBoxedOptionalCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> TouchBoxedOptionalCpi<'info> for crate::sdk_core_cpi::Program<crate::OptionalAccountsBorsh> {
    fn touch_boxed_optional_with_remaining_accounts<'a>(
        &self,
        call: TouchBoxedOptionalCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let TouchBoxedOptionalCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[44, 5, 78, 189, 42, 214, 82, 212]);

...
pub struct InitConfigAccounts {
    ...
    pub config: naclac_client::Address,
    pub system_program: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_init_config<'a>(
    ...
    let ix_data = crate::sdk_core_offchain::vec![23, 235, 115, 232, 168, 96, 1, 231];
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.config, is_signer: false, is_writable: true }, "config")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct InitConfigCpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub config: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct InitConfigCpiCall<'a> {
    pub accounts: InitConfigCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitConfigCpi<'info> {
    fn init_config<'a>(
        &self,
        accounts: InitConfigCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_config_with_remaining_accounts(InitConfigCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_config_with_remaining_accounts<'a>(
        &self,
        call: InitConfigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitConfigCpi<'info> for crate::sdk_core_cpi::Program<crate::DiscriminatorBorsh> {
    fn init_config_with_remaining_accounts<'a>(
        &self,
        call: InitConfigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitConfigCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[23, 235, 115, 232, 168, 96, 1, 231]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.config.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.config));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.config.address(), false),

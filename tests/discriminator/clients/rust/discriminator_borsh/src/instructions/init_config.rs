...
pub fn build_init_config<'a>(
    ...
    let ix_data = crate::sdk_core::vec![23, 235, 115, 232, 168, 96, 1, 231];
...
pub struct InitConfigCpiAccounts<'a> {
    ...
    pub config: crate::sdk_core::CpiHandleMut<'a>,
...
pub trait InitConfigCpi<'info> {
    fn init_config<'a>(
        ...
        self.init_config_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn init_config_signed<'a>(
        ...
        self.init_config_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> InitConfigCpi<'info> for crate::sdk_core::Program<crate::DiscriminatorBorsh> {
    fn init_config_with_remaining_accounts<'a>(
        &self,
        accounts: InitConfigCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core::pinocchio::instruction::InstructionAccount::writable(accounts.config.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core::CpiHandle::from(accounts.config));
            h_idx += 1;

...
pub struct LogEventFixed128IxArgs {
    pub data: [u8; 128],
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for LogEventFixed128IxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for LogEventFixed128IxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct LogEventFixed128CpiIxArgs {
    pub data: [u8; 128],
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for LogEventFixed128CpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for LogEventFixed128CpiIxArgs {}

#[cfg(feature = "offchain")]
pub fn build_log_event_fixed_128<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    data: [u8; 128],
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![149, 168, 176, 217, 140, 21, 77, 193];
    let args = LogEventFixed128IxArgs {
        data,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct LogEventFixed128CpiCall<'a> {
    pub data: [u8; 128],
...
#[cfg(feature = "cpi")]
pub trait LogEventFixed128Cpi<'info> {
    fn log_event_fixed_128<'a>(
        &self,
        data: [u8; 128]
    ) -> crate::sdk_core_cpi::Result<()> {
        self.log_event_fixed_128_with_remaining_accounts(LogEventFixed128CpiCall {
        data,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn log_event_fixed_128_signed<'a>(
        &self,
        data: [u8; 128],
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn log_event_fixed_128_with_remaining_accounts<'a>(
        &self,
        call: LogEventFixed128CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> LogEventFixed128Cpi<'info> for crate::sdk_core_cpi::Program<crate::EventsZc> {
    fn log_event_fixed_128_with_remaining_accounts<'a>(
        &self,
        call: LogEventFixed128CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let LogEventFixed128CpiCall { data, signer_seeds, remaining_accounts } = call;
        let args = LogEventFixed128CpiIxArgs {
            data,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[149, 168, 176, 217, 140, 21, 77, 193]);
        #[cfg(not(feature = "borsh"))]
        {

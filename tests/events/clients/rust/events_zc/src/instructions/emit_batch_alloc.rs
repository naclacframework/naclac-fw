...
pub struct EmitBatchAllocAccounts {
    pub counter: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_emit_batch_alloc<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: EmitBatchAllocAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![186, 210, 167, 115, 104, 189, 246, 44];
...
#[cfg(feature = "cpi")]
pub struct EmitBatchAllocCpiAccounts<'a> {
    pub counter: crate::sdk_core_cpi::CpiHandleMut<'a>,
}

#[cfg(feature = "cpi")]
pub struct EmitBatchAllocCpiCall<'a> {
    pub accounts: EmitBatchAllocCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait EmitBatchAllocCpi<'info> {
    fn emit_batch_alloc<'a>(
        &self,
        accounts: EmitBatchAllocCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.emit_batch_alloc_with_remaining_accounts(EmitBatchAllocCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn emit_batch_alloc_with_remaining_accounts<'a>(
        &self,
        call: EmitBatchAllocCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> EmitBatchAllocCpi<'info> for crate::sdk_core_cpi::Program<crate::EventsZc> {
    fn emit_batch_alloc_with_remaining_accounts<'a>(
        &self,
        call: EmitBatchAllocCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let EmitBatchAllocCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[186, 210, 167, 115, 104, 189, 246, 44]);

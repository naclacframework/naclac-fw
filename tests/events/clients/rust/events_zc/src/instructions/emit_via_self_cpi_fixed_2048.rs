...
pub struct EmitViaSelfCpiFixed2048Accounts {
...
#[cfg(feature = "offchain")]
/// See `emit_via_self_cpi_fixed_8` — same purpose, 2048-byte fixed payload.
pub fn build_emit_via_self_cpi_fixed_2048<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: EmitViaSelfCpiFixed2048Accounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![194, 144, 39, 142, 20, 223, 200, 199];
...
#[cfg(feature = "cpi")]
/// See `emit_via_self_cpi_fixed_8` — same purpose, 2048-byte fixed payload.
pub struct EmitViaSelfCpiFixed2048CpiAccounts<'a> {
    /// SAFETY: only its address is checked; its data is never read.
    pub program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct EmitViaSelfCpiFixed2048CpiCall<'a> {
    pub accounts: EmitViaSelfCpiFixed2048CpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait EmitViaSelfCpiFixed2048Cpi<'info> {
    /// See `emit_via_self_cpi_fixed_8` — same purpose, 2048-byte fixed payload.
    fn emit_via_self_cpi_fixed_2048<'a>(
        &self,
        accounts: EmitViaSelfCpiFixed2048CpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.emit_via_self_cpi_fixed_2048_with_remaining_accounts(EmitViaSelfCpiFixed2048CpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn emit_via_self_cpi_fixed_2048_signed<'a>(
        &self,
        accounts: EmitViaSelfCpiFixed2048CpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn emit_via_self_cpi_fixed_2048_with_remaining_accounts<'a>(
        &self,
        call: EmitViaSelfCpiFixed2048CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> EmitViaSelfCpiFixed2048Cpi<'info> for crate::sdk_core_cpi::Program<crate::EventsZc> {
    fn emit_via_self_cpi_fixed_2048_with_remaining_accounts<'a>(
        &self,
        call: EmitViaSelfCpiFixed2048CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let EmitViaSelfCpiFixed2048CpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[194, 144, 39, 142, 20, 223, 200, 199]);

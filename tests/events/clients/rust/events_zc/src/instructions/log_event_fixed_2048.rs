...
pub struct LogEventFixed2048IxArgs {
    pub data: [u8; 2048],
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for LogEventFixed2048IxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for LogEventFixed2048IxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct LogEventFixed2048CpiIxArgs {
    pub data: [u8; 2048],
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for LogEventFixed2048CpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for LogEventFixed2048CpiIxArgs {}

#[cfg(feature = "offchain")]
pub fn build_log_event_fixed_2048<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    data: [u8; 2048],
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![18, 221, 231, 102, 205, 46, 191, 231];
    let args = LogEventFixed2048IxArgs {
        data,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct LogEventFixed2048CpiCall<'a> {
    pub data: [u8; 2048],
...
#[cfg(feature = "cpi")]
pub trait LogEventFixed2048Cpi<'info> {
    fn log_event_fixed_2048<'a>(
        &self,
        data: [u8; 2048]
    ) -> crate::sdk_core_cpi::Result<()> {
        self.log_event_fixed_2048_with_remaining_accounts(LogEventFixed2048CpiCall {
        data,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn log_event_fixed_2048_signed<'a>(
        &self,
        data: [u8; 2048],
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn log_event_fixed_2048_with_remaining_accounts<'a>(
        &self,
        call: LogEventFixed2048CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> LogEventFixed2048Cpi<'info> for crate::sdk_core_cpi::Program<crate::EventsZc> {
    fn log_event_fixed_2048_with_remaining_accounts<'a>(
        &self,
        call: LogEventFixed2048CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let LogEventFixed2048CpiCall { data, signer_seeds, remaining_accounts } = call;
        let args = LogEventFixed2048CpiIxArgs {
            data,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[18, 221, 231, 102, 205, 46, 191, 231]);
        #[cfg(not(feature = "borsh"))]
        {

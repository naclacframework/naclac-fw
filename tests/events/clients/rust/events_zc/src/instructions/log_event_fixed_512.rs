...
pub struct LogEventFixed512IxArgs {
    pub data: [u8; 512],
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for LogEventFixed512IxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for LogEventFixed512IxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct LogEventFixed512CpiIxArgs {
    pub data: [u8; 512],
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for LogEventFixed512CpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for LogEventFixed512CpiIxArgs {}

#[cfg(feature = "offchain")]
pub fn build_log_event_fixed_512<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    data: [u8; 512],
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![134, 104, 190, 181, 234, 155, 142, 191];
    let args = LogEventFixed512IxArgs {
        data,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct LogEventFixed512CpiCall<'a> {
    pub data: [u8; 512],
...
#[cfg(feature = "cpi")]
pub trait LogEventFixed512Cpi<'info> {
    fn log_event_fixed_512<'a>(
        &self,
        data: [u8; 512]
    ) -> crate::sdk_core_cpi::Result<()> {
        self.log_event_fixed_512_with_remaining_accounts(LogEventFixed512CpiCall {
        data,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn log_event_fixed_512_signed<'a>(
        &self,
        data: [u8; 512],
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn log_event_fixed_512_with_remaining_accounts<'a>(
        &self,
        call: LogEventFixed512CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> LogEventFixed512Cpi<'info> for crate::sdk_core_cpi::Program<crate::EventsZc> {
    fn log_event_fixed_512_with_remaining_accounts<'a>(
        &self,
        call: LogEventFixed512CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let LogEventFixed512CpiCall { data, signer_seeds, remaining_accounts } = call;
        let args = LogEventFixed512CpiIxArgs {
            data,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[134, 104, 190, 181, 234, 155, 142, 191]);
        #[cfg(not(feature = "borsh"))]
        {

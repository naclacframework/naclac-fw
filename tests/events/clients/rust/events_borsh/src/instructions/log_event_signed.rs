...
pub struct LogEventSignedIxArgs {
    pub data: [u8; 8],
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for LogEventSignedIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for LogEventSignedIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct LogEventSignedCpiIxArgs {
    pub data: [u8; 8],
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for LogEventSignedCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for LogEventSignedCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct LogEventSignedAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_log_event_signed<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    data: [u8; 8],
    accounts: LogEventSignedAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![251, 224, 120, 207, 75, 64, 255, 194];
    let args = LogEventSignedIxArgs {
        data,
    };
    #[cfg(not(feature = "borsh"))]
    {
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        .account(naclac_client::AccountMeta { address: accounts.event_authority, is_signer: true, is_writable: false }, "event_authority")
}

#[cfg(feature = "cpi")]
pub struct LogEventSignedCpiAccounts<'a> {
    /// SAFETY: only its address (against the PDA derived from
    /// `SEED_EVENT_AUTHORITY`) and `is_signer` are checked; its data is
    /// never read.
...
#[cfg(feature = "cpi")]
pub struct LogEventSignedCpiCall<'a> {
    pub accounts: LogEventSignedCpiAccounts<'a>,
    pub data: [u8; 8],
...
#[cfg(feature = "cpi")]
pub trait LogEventSignedCpi<'info> {
    fn log_event_signed<'a>(
        &self,
        accounts: LogEventSignedCpiAccounts<'a>,
        data: [u8; 8]
    ) -> crate::sdk_core_cpi::Result<()> {
        self.log_event_signed_with_remaining_accounts(LogEventSignedCpiCall {
        accounts,
        data,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn log_event_signed_with_remaining_accounts<'a>(
        &self,
        call: LogEventSignedCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> LogEventSignedCpi<'info> for crate::sdk_core_cpi::Program<crate::EventsBorsh> {
    fn log_event_signed_with_remaining_accounts<'a>(
        &self,
        call: LogEventSignedCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let LogEventSignedCpiCall { accounts, data, signer_seeds, remaining_accounts } = call;
        let args = LogEventSignedCpiIxArgs {
            data,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[251, 224, 120, 207, 75, 64, 255, 194]);
        #[cfg(not(feature = "borsh"))]
        {
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            let mut idx = 0;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::readonly_signer(accounts.event_authority.info.view.address()));
            idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ::naclac_lang::solana_program::instruction::AccountMeta::new_readonly(accounts.event_authority.address(), true),
            ];
            for (acc, is_writable, is_signer) in remaining_accounts {
                let meta = if *is_writable {

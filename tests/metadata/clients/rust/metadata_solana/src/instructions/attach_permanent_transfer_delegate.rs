...
pub struct AttachPermanentTransferDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_permanent_transfer_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachPermanentTransferDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![43, 83, 218, 144, 107, 26, 174, 225];
...
#[cfg(feature = "cpi")]
pub struct AttachPermanentTransferDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachPermanentTransferDelegateCpiCall<'a> {
    pub accounts: AttachPermanentTransferDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachPermanentTransferDelegateCpi<'info> {
    fn attach_permanent_transfer_delegate<'a>(
        &self,
        accounts: AttachPermanentTransferDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_permanent_transfer_delegate_with_remaining_accounts(AttachPermanentTransferDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_permanent_transfer_delegate_signed<'a>(
        &self,
        accounts: AttachPermanentTransferDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_permanent_transfer_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachPermanentTransferDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachPermanentTransferDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_permanent_transfer_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachPermanentTransferDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachPermanentTransferDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[43, 83, 218, 144, 107, 26, 174, 225]);

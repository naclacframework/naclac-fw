...
pub struct AttachPermanentFreezeExecuteAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_permanent_freeze_execute<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachPermanentFreezeExecuteAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![72, 8, 33, 210, 34, 104, 27, 29];
...
#[cfg(feature = "cpi")]
pub struct AttachPermanentFreezeExecuteCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachPermanentFreezeExecuteCpiCall<'a> {
    pub accounts: AttachPermanentFreezeExecuteCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachPermanentFreezeExecuteCpi<'info> {
    fn attach_permanent_freeze_execute<'a>(
        &self,
        accounts: AttachPermanentFreezeExecuteCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_permanent_freeze_execute_with_remaining_accounts(AttachPermanentFreezeExecuteCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_permanent_freeze_execute_signed<'a>(
        &self,
        accounts: AttachPermanentFreezeExecuteCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_permanent_freeze_execute_with_remaining_accounts<'a>(
        &self,
        call: AttachPermanentFreezeExecuteCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachPermanentFreezeExecuteCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_permanent_freeze_execute_with_remaining_accounts<'a>(
        &self,
        call: AttachPermanentFreezeExecuteCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachPermanentFreezeExecuteCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[72, 8, 33, 210, 34, 104, 27, 29]);

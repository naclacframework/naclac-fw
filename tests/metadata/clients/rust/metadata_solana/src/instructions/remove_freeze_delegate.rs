...
pub struct RemoveFreezeDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_remove_freeze_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: RemoveFreezeDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![101, 175, 74, 161, 9, 116, 53, 50];
...
#[cfg(feature = "cpi")]
pub struct RemoveFreezeDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct RemoveFreezeDelegateCpiCall<'a> {
    pub accounts: RemoveFreezeDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait RemoveFreezeDelegateCpi<'info> {
    fn remove_freeze_delegate<'a>(
        &self,
        accounts: RemoveFreezeDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.remove_freeze_delegate_with_remaining_accounts(RemoveFreezeDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn remove_freeze_delegate_signed<'a>(
        &self,
        accounts: RemoveFreezeDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn remove_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: RemoveFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> RemoveFreezeDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn remove_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: RemoveFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let RemoveFreezeDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[101, 175, 74, 161, 9, 116, 53, 50]);

...
pub struct AttachFreezeExecuteAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_freeze_execute<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachFreezeExecuteAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![178, 250, 79, 53, 181, 58, 163, 135];
...
#[cfg(feature = "cpi")]
pub struct AttachFreezeExecuteCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachFreezeExecuteCpiCall<'a> {
    pub accounts: AttachFreezeExecuteCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachFreezeExecuteCpi<'info> {
    fn attach_freeze_execute<'a>(
        &self,
        accounts: AttachFreezeExecuteCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_freeze_execute_with_remaining_accounts(AttachFreezeExecuteCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_freeze_execute_signed<'a>(
        &self,
        accounts: AttachFreezeExecuteCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_freeze_execute_with_remaining_accounts<'a>(
        &self,
        call: AttachFreezeExecuteCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachFreezeExecuteCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_freeze_execute_with_remaining_accounts<'a>(
        &self,
        call: AttachFreezeExecuteCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachFreezeExecuteCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[178, 250, 79, 53, 181, 58, 163, 135]);

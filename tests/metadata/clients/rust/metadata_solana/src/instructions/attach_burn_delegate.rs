...
pub struct AttachBurnDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_burn_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachBurnDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![132, 245, 159, 198, 236, 241, 88, 117];
...
#[cfg(feature = "cpi")]
pub struct AttachBurnDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachBurnDelegateCpiCall<'a> {
    pub accounts: AttachBurnDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachBurnDelegateCpi<'info> {
    fn attach_burn_delegate<'a>(
        &self,
        accounts: AttachBurnDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_burn_delegate_with_remaining_accounts(AttachBurnDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_burn_delegate_signed<'a>(
        &self,
        accounts: AttachBurnDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_burn_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachBurnDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachBurnDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_burn_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachBurnDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachBurnDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[132, 245, 159, 198, 236, 241, 88, 117]);

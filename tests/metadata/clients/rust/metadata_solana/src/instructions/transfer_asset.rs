...
pub struct TransferAssetAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_transfer_asset<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: TransferAssetAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![126, 66, 109, 18, 60, 172, 131, 124];
...
#[cfg(feature = "cpi")]
pub struct TransferAssetCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct TransferAssetCpiCall<'a> {
    pub accounts: TransferAssetCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait TransferAssetCpi<'info> {
    fn transfer_asset<'a>(
        &self,
        accounts: TransferAssetCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.transfer_asset_with_remaining_accounts(TransferAssetCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn transfer_asset_with_remaining_accounts<'a>(
        &self,
        call: TransferAssetCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> TransferAssetCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn transfer_asset_with_remaining_accounts<'a>(
        &self,
        call: TransferAssetCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let TransferAssetCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[126, 66, 109, 18, 60, 172, 131, 124]);

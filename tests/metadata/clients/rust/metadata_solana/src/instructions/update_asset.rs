...
pub fn build_update_asset<'a>(
    ...
    accounts: UpdateAssetAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![56, 126, 238, 138, 192, 118, 228, 172];
    let args = UpdateAssetIxArgs {
        new_name,
        new_uri,
    };
...
#[cfg(feature = "cpi")]
pub struct UpdateAssetCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct UpdateAssetCpiCall<'a> {
    pub accounts: UpdateAssetCpiAccounts<'a>,
    pub new_name: crate::sdk_core_cpi::ZcString,
    pub new_uri: crate::sdk_core_cpi::ZcString,
...
#[cfg(feature = "cpi")]
pub trait UpdateAssetCpi<'info> {
    fn update_asset<'a>(
        &self,
        accounts: UpdateAssetCpiAccounts<'a>,
        new_name: crate::sdk_core_cpi::ZcString,
        new_uri: crate::sdk_core_cpi::ZcString
    ) -> crate::sdk_core_cpi::Result<()> {
        self.update_asset_with_remaining_accounts(UpdateAssetCpiCall {
        accounts,
        new_name,
        new_uri,
        signer_seeds: &[],
    ...
    fn update_asset_with_remaining_accounts<'a>(
        &self,
        call: UpdateAssetCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> UpdateAssetCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn update_asset_with_remaining_accounts<'a>(
        &self,
        call: UpdateAssetCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let UpdateAssetCpiCall { accounts, new_name, new_uri, signer_seeds, remaining_accounts } = call;
        let args = UpdateAssetCpiIxArgs {
            new_name,
            new_uri,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[56, 126, 238, 138, 192, 118, 228, 172]);
        #[cfg(not(feature = "borsh"))]
        {
        ix_data.extend_from_slice(&(args.new_name.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.new_name.as_bytes());

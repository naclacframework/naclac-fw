...
pub struct AddGroupsToGroupAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_add_groups_to_group<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AddGroupsToGroupAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![168, 132, 246, 173, 125, 155, 114, 30];
...
#[cfg(feature = "cpi")]
pub struct AddGroupsToGroupCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AddGroupsToGroupCpiCall<'a> {
    pub accounts: AddGroupsToGroupCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AddGroupsToGroupCpi<'info> {
    fn add_groups_to_group<'a>(
        &self,
        accounts: AddGroupsToGroupCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.add_groups_to_group_with_remaining_accounts(AddGroupsToGroupCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn add_groups_to_group_signed<'a>(
        &self,
        accounts: AddGroupsToGroupCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn add_groups_to_group_with_remaining_accounts<'a>(
        &self,
        call: AddGroupsToGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AddGroupsToGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn add_groups_to_group_with_remaining_accounts<'a>(
        &self,
        call: AddGroupsToGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AddGroupsToGroupCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[168, 132, 246, 173, 125, 155, 114, 30]);

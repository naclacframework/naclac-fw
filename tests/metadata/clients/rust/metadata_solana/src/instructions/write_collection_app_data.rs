...
pub struct WriteCollectionAppDataAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_write_collection_app_data<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: WriteCollectionAppDataAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![168, 73, 130, 60, 213, 175, 110, 254];
...
#[cfg(feature = "cpi")]
pub struct WriteCollectionAppDataCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct WriteCollectionAppDataCpiCall<'a> {
    pub accounts: WriteCollectionAppDataCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait WriteCollectionAppDataCpi<'info> {
    fn write_collection_app_data<'a>(
        &self,
        accounts: WriteCollectionAppDataCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.write_collection_app_data_with_remaining_accounts(WriteCollectionAppDataCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn write_collection_app_data_signed<'a>(
        &self,
        accounts: WriteCollectionAppDataCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn write_collection_app_data_with_remaining_accounts<'a>(
        &self,
        call: WriteCollectionAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> WriteCollectionAppDataCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn write_collection_app_data_with_remaining_accounts<'a>(
        &self,
        call: WriteCollectionAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let WriteCollectionAppDataCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[168, 73, 130, 60, 213, 175, 110, 254]);

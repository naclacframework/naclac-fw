...
#[cfg_attr(not(feature = "borsh"), derive(Clone, Debug))]
pub struct CreateGroupCpiIxArgs {
...
pub fn build_create_group<'a>(
    ...
    let mut ix_data = crate::sdk_core_offchain::vec![79, 60, 158, 134, 61, 199, 56, 248];
    let args = CreateGroupIxArgs {
        name,
        uri,
    };
...
#[cfg(feature = "cpi")]
pub struct CreateGroupCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CreateGroupCpiCall<'a> {
    pub accounts: CreateGroupCpiAccounts<'a>,
    pub name: crate::sdk_core_cpi::ZcString,
    pub uri: crate::sdk_core_cpi::ZcString,
...
#[cfg(feature = "cpi")]
pub trait CreateGroupCpi<'info> {
    fn create_group<'a>(
        &self,
        accounts: CreateGroupCpiAccounts<'a>,
        name: crate::sdk_core_cpi::ZcString,
        uri: crate::sdk_core_cpi::ZcString
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_group_with_remaining_accounts(CreateGroupCpiCall {
        accounts,
        name,
        uri,
        signer_seeds: &[],
    ...
    fn create_group_with_remaining_accounts<'a>(
        &self,
        call: CreateGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn create_group_with_remaining_accounts<'a>(
        &self,
        call: CreateGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateGroupCpiCall { accounts, name, uri, signer_seeds, remaining_accounts } = call;
        let args = CreateGroupCpiIxArgs {
            name,
            uri,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[79, 60, 158, 134, 61, 199, 56, 248]);
        #[cfg(not(feature = "borsh"))]
        {
        ix_data.extend_from_slice(&(args.name.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.name.as_bytes());

...
pub struct AttachBubblegumV2Accounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_bubblegum_v2<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachBubblegumV2Accounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![33, 23, 62, 116, 130, 30, 29, 200];
...
#[cfg(feature = "cpi")]
pub struct AttachBubblegumV2CpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachBubblegumV2CpiCall<'a> {
    pub accounts: AttachBubblegumV2CpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachBubblegumV2Cpi<'info> {
    fn attach_bubblegum_v2<'a>(
        &self,
        accounts: AttachBubblegumV2CpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_bubblegum_v2_with_remaining_accounts(AttachBubblegumV2CpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_bubblegum_v2_signed<'a>(
        &self,
        accounts: AttachBubblegumV2CpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_bubblegum_v2_with_remaining_accounts<'a>(
        &self,
        call: AttachBubblegumV2CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachBubblegumV2Cpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_bubblegum_v2_with_remaining_accounts<'a>(
        &self,
        call: AttachBubblegumV2CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachBubblegumV2CpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[33, 23, 62, 116, 130, 30, 29, 200]);

...
pub struct CreateCollectionIxArgs {
...
#[cfg_attr(not(feature = "borsh"), derive(Clone, Debug))]
pub struct CreateCollectionCpiIxArgs {
    pub name: crate::sdk_core_cpi::ZcString,
    pub uri: crate::sdk_core_cpi::ZcString,
}

#[cfg(feature = "offchain")]
pub struct CreateCollectionAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_create_collection<'a>(
    ...
    let mut ix_data = crate::sdk_core_offchain::vec![156, 251, 92, 54, 233, 2, 16, 82];
    let args = CreateCollectionIxArgs {
        name,
        uri,
    };
...
#[cfg(feature = "cpi")]
pub struct CreateCollectionCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CreateCollectionCpiCall<'a> {
    pub accounts: CreateCollectionCpiAccounts<'a>,
    pub name: crate::sdk_core_cpi::ZcString,
    pub uri: crate::sdk_core_cpi::ZcString,
...
#[cfg(feature = "cpi")]
pub trait CreateCollectionCpi<'info> {
    fn create_collection<'a>(
        &self,
        accounts: CreateCollectionCpiAccounts<'a>,
        name: crate::sdk_core_cpi::ZcString,
        uri: crate::sdk_core_cpi::ZcString
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_collection_with_remaining_accounts(CreateCollectionCpiCall {
        accounts,
        name,
        uri,
        signer_seeds: &[],
    ...
    fn create_collection_with_remaining_accounts<'a>(
        &self,
        call: CreateCollectionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateCollectionCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn create_collection_with_remaining_accounts<'a>(
        &self,
        call: CreateCollectionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateCollectionCpiCall { accounts, name, uri, signer_seeds, remaining_accounts } = call;
        let args = CreateCollectionCpiIxArgs {
            name,
            uri,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[156, 251, 92, 54, 233, 2, 16, 82]);
        #[cfg(not(feature = "borsh"))]
        {
        ix_data.extend_from_slice(&(args.name.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.name.as_bytes());

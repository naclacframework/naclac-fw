...
pub struct AttachTransferDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_transfer_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachTransferDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![206, 47, 37, 248, 74, 212, 214, 157];
...
#[cfg(feature = "cpi")]
pub struct AttachTransferDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachTransferDelegateCpiCall<'a> {
    pub accounts: AttachTransferDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachTransferDelegateCpi<'info> {
    fn attach_transfer_delegate<'a>(
        &self,
        accounts: AttachTransferDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_transfer_delegate_with_remaining_accounts(AttachTransferDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_transfer_delegate_signed<'a>(
        &self,
        accounts: AttachTransferDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_transfer_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachTransferDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachTransferDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_transfer_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachTransferDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachTransferDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[206, 47, 37, 248, 74, 212, 214, 157]);

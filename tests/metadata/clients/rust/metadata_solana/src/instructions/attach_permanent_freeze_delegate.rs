...
pub struct AttachPermanentFreezeDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_permanent_freeze_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachPermanentFreezeDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![166, 5, 169, 106, 240, 96, 70, 219];
...
#[cfg(feature = "cpi")]
pub struct AttachPermanentFreezeDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachPermanentFreezeDelegateCpiCall<'a> {
    pub accounts: AttachPermanentFreezeDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachPermanentFreezeDelegateCpi<'info> {
    fn attach_permanent_freeze_delegate<'a>(
        &self,
        accounts: AttachPermanentFreezeDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_permanent_freeze_delegate_with_remaining_accounts(AttachPermanentFreezeDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_permanent_freeze_delegate_signed<'a>(
        &self,
        accounts: AttachPermanentFreezeDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_permanent_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachPermanentFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachPermanentFreezeDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_permanent_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachPermanentFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachPermanentFreezeDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[166, 5, 169, 106, 240, 96, 70, 219]);

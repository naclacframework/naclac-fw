...
pub struct ApprovePluginAuthorityAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_approve_plugin_authority<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: ApprovePluginAuthorityAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![138, 91, 203, 231, 137, 85, 91, 34];
...
#[cfg(feature = "cpi")]
pub struct ApprovePluginAuthorityCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct ApprovePluginAuthorityCpiCall<'a> {
    pub accounts: ApprovePluginAuthorityCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait ApprovePluginAuthorityCpi<'info> {
    fn approve_plugin_authority<'a>(
        &self,
        accounts: ApprovePluginAuthorityCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.approve_plugin_authority_with_remaining_accounts(ApprovePluginAuthorityCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn approve_plugin_authority_signed<'a>(
        &self,
        accounts: ApprovePluginAuthorityCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn approve_plugin_authority_with_remaining_accounts<'a>(
        &self,
        call: ApprovePluginAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> ApprovePluginAuthorityCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn approve_plugin_authority_with_remaining_accounts<'a>(
        &self,
        call: ApprovePluginAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let ApprovePluginAuthorityCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[138, 91, 203, 231, 137, 85, 91, 34]);

...
pub struct UpdateCollectionIxArgs {
    pub new_name: crate::sdk_core_offchain::String,
    pub new_uri: crate::sdk_core_offchain::String,
}
...
#[cfg_attr(not(feature = "borsh"), derive(Clone, Debug))]
pub struct UpdateCollectionCpiIxArgs {
    pub new_name: crate::sdk_core_cpi::ZcString,
    pub new_uri: crate::sdk_core_cpi::ZcString,
}

#[cfg(feature = "offchain")]
pub struct UpdateCollectionAccounts {
...
pub fn build_update_collection<'a>(
    ...
    #[cfg(not(feature = "borsh"))]
    {
        ...
        ix_data.extend_from_slice(&(args.new_uri.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.new_uri.as_bytes());
    }
    #[cfg(feature = "borsh")]
    {
...
#[cfg(feature = "cpi")]
pub struct UpdateCollectionCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct UpdateCollectionCpiCall<'a> {
    pub accounts: UpdateCollectionCpiAccounts<'a>,
    pub new_name: crate::sdk_core_cpi::ZcString,
    pub new_uri: crate::sdk_core_cpi::ZcString,
...
#[cfg(feature = "cpi")]
pub trait UpdateCollectionCpi<'info> {
    fn update_collection<'a>(
        &self,
        accounts: UpdateCollectionCpiAccounts<'a>,
        new_name: crate::sdk_core_cpi::ZcString,
        new_uri: crate::sdk_core_cpi::ZcString
    ) -> crate::sdk_core_cpi::Result<()> {
        self.update_collection_with_remaining_accounts(UpdateCollectionCpiCall {
        accounts,
        new_name,
        new_uri,
        signer_seeds: &[],
    ...
    fn update_collection_with_remaining_accounts<'a>(
        &self,
        call: UpdateCollectionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> UpdateCollectionCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn update_collection_with_remaining_accounts<'a>(
        &self,
        call: UpdateCollectionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let UpdateCollectionCpiCall { accounts, new_name, new_uri, signer_seeds, remaining_accounts } = call;
        let args = UpdateCollectionCpiIxArgs {
            new_name,
            new_uri,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[97, 70, 36, 49, 138, 12, 199, 239]);
        #[cfg(not(feature = "borsh"))]
        {
        ix_data.extend_from_slice(&(args.new_name.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.new_name.as_bytes());

...
pub struct AttachAttributesIxArgs {
    pub key: crate::sdk_core_offchain::String,
    pub value: crate::sdk_core_offchain::String,
}
...
#[cfg_attr(not(feature = "borsh"), derive(Clone, Debug))]
pub struct AttachAttributesCpiIxArgs {
    pub key: crate::sdk_core_cpi::ZcString,
    pub value: crate::sdk_core_cpi::ZcString,
}

#[cfg(feature = "offchain")]
pub struct AttachAttributesAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_attributes<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    key: crate::sdk_core_offchain::String,
    value: crate::sdk_core_offchain::String,
    accounts: AttachAttributesAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![116, 30, 160, 233, 83, 45, 245, 53];
    let args = AttachAttributesIxArgs {
        key,
        value,
    };
    #[cfg(not(feature = "borsh"))]
    {
        ix_data.extend_from_slice(&(args.key.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.key.as_bytes());
        ix_data.extend_from_slice(&(args.value.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.value.as_bytes());
    }
    #[cfg(feature = "borsh")]
    {
...
#[cfg(feature = "cpi")]
pub struct AttachAttributesCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachAttributesCpiCall<'a> {
    pub accounts: AttachAttributesCpiAccounts<'a>,
    pub key: crate::sdk_core_cpi::ZcString,
    pub value: crate::sdk_core_cpi::ZcString,
...
#[cfg(feature = "cpi")]
pub trait AttachAttributesCpi<'info> {
    fn attach_attributes<'a>(
        &self,
        accounts: AttachAttributesCpiAccounts<'a>,
        key: crate::sdk_core_cpi::ZcString,
        value: crate::sdk_core_cpi::ZcString
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_attributes_with_remaining_accounts(AttachAttributesCpiCall {
        accounts,
        key,
        value,
        signer_seeds: &[],
    ...
    fn attach_attributes_with_remaining_accounts<'a>(
        &self,
        call: AttachAttributesCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachAttributesCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_attributes_with_remaining_accounts<'a>(
        &self,
        call: AttachAttributesCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachAttributesCpiCall { accounts, key, value, signer_seeds, remaining_accounts } = call;
        let args = AttachAttributesCpiIxArgs {
            key,
            value,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[116, 30, 160, 233, 83, 45, 245, 53]);
        #[cfg(not(feature = "borsh"))]
        {
        ix_data.extend_from_slice(&(args.key.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.key.as_bytes());

...
pub struct AttachCollectionAppDataAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_collection_app_data<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachCollectionAppDataAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![113, 52, 45, 26, 79, 198, 212, 178];
...
#[cfg(feature = "cpi")]
pub struct AttachCollectionAppDataCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachCollectionAppDataCpiCall<'a> {
    pub accounts: AttachCollectionAppDataCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachCollectionAppDataCpi<'info> {
    fn attach_collection_app_data<'a>(
        &self,
        accounts: AttachCollectionAppDataCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_collection_app_data_with_remaining_accounts(AttachCollectionAppDataCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_collection_app_data_signed<'a>(
        &self,
        accounts: AttachCollectionAppDataCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_collection_app_data_with_remaining_accounts<'a>(
        &self,
        call: AttachCollectionAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachCollectionAppDataCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_collection_app_data_with_remaining_accounts<'a>(
        &self,
        call: AttachCollectionAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachCollectionAppDataCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[113, 52, 45, 26, 79, 198, 212, 178]);

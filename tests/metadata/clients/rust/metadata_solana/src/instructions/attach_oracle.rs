...
pub struct AttachOracleAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_oracle<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachOracleAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![2, 137, 190, 161, 13, 69, 72, 153];
...
#[cfg(feature = "cpi")]
pub struct AttachOracleCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachOracleCpiCall<'a> {
    pub accounts: AttachOracleCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachOracleCpi<'info> {
    fn attach_oracle<'a>(
        &self,
        accounts: AttachOracleCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_oracle_with_remaining_accounts(AttachOracleCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_oracle_with_remaining_accounts<'a>(
        &self,
        call: AttachOracleCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachOracleCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_oracle_with_remaining_accounts<'a>(
        &self,
        call: AttachOracleCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachOracleCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[2, 137, 190, 161, 13, 69, 72, 153]);

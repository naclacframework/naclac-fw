...
pub struct AttachPermanentBurnDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_permanent_burn_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachPermanentBurnDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![184, 96, 52, 21, 18, 10, 49, 8];
...
#[cfg(feature = "cpi")]
pub struct AttachPermanentBurnDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachPermanentBurnDelegateCpiCall<'a> {
    pub accounts: AttachPermanentBurnDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachPermanentBurnDelegateCpi<'info> {
    fn attach_permanent_burn_delegate<'a>(
        &self,
        accounts: AttachPermanentBurnDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_permanent_burn_delegate_with_remaining_accounts(AttachPermanentBurnDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_permanent_burn_delegate_signed<'a>(
        &self,
        accounts: AttachPermanentBurnDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_permanent_burn_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachPermanentBurnDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachPermanentBurnDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_permanent_burn_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachPermanentBurnDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachPermanentBurnDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[184, 96, 52, 21, 18, 10, 49, 8]);

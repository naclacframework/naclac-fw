...
pub struct AttachUpdateDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_update_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachUpdateDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![110, 155, 98, 71, 79, 199, 43, 81];
...
#[cfg(feature = "cpi")]
pub struct AttachUpdateDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachUpdateDelegateCpiCall<'a> {
    pub accounts: AttachUpdateDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachUpdateDelegateCpi<'info> {
    fn attach_update_delegate<'a>(
        &self,
        accounts: AttachUpdateDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_update_delegate_with_remaining_accounts(AttachUpdateDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_update_delegate_signed<'a>(
        &self,
        accounts: AttachUpdateDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_update_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachUpdateDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachUpdateDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_update_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachUpdateDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachUpdateDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[110, 155, 98, 71, 79, 199, 43, 81]);

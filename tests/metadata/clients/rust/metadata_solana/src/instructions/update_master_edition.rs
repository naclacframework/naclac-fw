...
pub struct UpdateMasterEditionAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_update_master_edition<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: UpdateMasterEditionAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![58, 31, 97, 13, 114, 181, 243, 188];
...
#[cfg(feature = "cpi")]
pub struct UpdateMasterEditionCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct UpdateMasterEditionCpiCall<'a> {
    pub accounts: UpdateMasterEditionCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait UpdateMasterEditionCpi<'info> {
    fn update_master_edition<'a>(
        &self,
        accounts: UpdateMasterEditionCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.update_master_edition_with_remaining_accounts(UpdateMasterEditionCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn update_master_edition_signed<'a>(
        &self,
        accounts: UpdateMasterEditionCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn update_master_edition_with_remaining_accounts<'a>(
        &self,
        call: UpdateMasterEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> UpdateMasterEditionCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn update_master_edition_with_remaining_accounts<'a>(
        &self,
        call: UpdateMasterEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let UpdateMasterEditionCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[58, 31, 97, 13, 114, 181, 243, 188]);

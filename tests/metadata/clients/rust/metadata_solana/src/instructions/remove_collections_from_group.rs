...
pub struct RemoveCollectionsFromGroupAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_remove_collections_from_group<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: RemoveCollectionsFromGroupAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![216, 164, 78, 220, 16, 246, 51, 17];
...
#[cfg(feature = "cpi")]
pub struct RemoveCollectionsFromGroupCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct RemoveCollectionsFromGroupCpiCall<'a> {
    pub accounts: RemoveCollectionsFromGroupCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait RemoveCollectionsFromGroupCpi<'info> {
    fn remove_collections_from_group<'a>(
        &self,
        accounts: RemoveCollectionsFromGroupCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.remove_collections_from_group_with_remaining_accounts(RemoveCollectionsFromGroupCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn remove_collections_from_group_signed<'a>(
        &self,
        accounts: RemoveCollectionsFromGroupCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn remove_collections_from_group_with_remaining_accounts<'a>(
        &self,
        call: RemoveCollectionsFromGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> RemoveCollectionsFromGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn remove_collections_from_group_with_remaining_accounts<'a>(
        &self,
        call: RemoveCollectionsFromGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let RemoveCollectionsFromGroupCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[216, 164, 78, 220, 16, 246, 51, 17]);

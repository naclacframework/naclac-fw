...
pub struct AddCollectionsToGroupAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_add_collections_to_group<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AddCollectionsToGroupAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![221, 130, 31, 122, 111, 70, 238, 181];
...
#[cfg(feature = "cpi")]
pub struct AddCollectionsToGroupCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AddCollectionsToGroupCpiCall<'a> {
    pub accounts: AddCollectionsToGroupCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AddCollectionsToGroupCpi<'info> {
    fn add_collections_to_group<'a>(
        &self,
        accounts: AddCollectionsToGroupCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.add_collections_to_group_with_remaining_accounts(AddCollectionsToGroupCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn add_collections_to_group_signed<'a>(
        &self,
        accounts: AddCollectionsToGroupCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn add_collections_to_group_with_remaining_accounts<'a>(
        &self,
        call: AddCollectionsToGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AddCollectionsToGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn add_collections_to_group_with_remaining_accounts<'a>(
        &self,
        call: AddCollectionsToGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AddCollectionsToGroupCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[221, 130, 31, 122, 111, 70, 238, 181]);

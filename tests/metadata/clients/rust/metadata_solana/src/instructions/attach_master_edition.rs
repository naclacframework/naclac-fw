...
pub struct AttachMasterEditionAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_master_edition<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachMasterEditionAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![169, 9, 171, 228, 250, 222, 93, 97];
...
#[cfg(feature = "cpi")]
pub struct AttachMasterEditionCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachMasterEditionCpiCall<'a> {
    pub accounts: AttachMasterEditionCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachMasterEditionCpi<'info> {
    fn attach_master_edition<'a>(
        &self,
        accounts: AttachMasterEditionCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_master_edition_with_remaining_accounts(AttachMasterEditionCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_master_edition_signed<'a>(
        &self,
        accounts: AttachMasterEditionCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_master_edition_with_remaining_accounts<'a>(
        &self,
        call: AttachMasterEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachMasterEditionCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_master_edition_with_remaining_accounts<'a>(
        &self,
        call: AttachMasterEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachMasterEditionCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[169, 9, 171, 228, 250, 222, 93, 97]);

...
pub struct UpdateCollectionAppDataAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_update_collection_app_data<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: UpdateCollectionAppDataAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![48, 62, 77, 91, 131, 140, 107, 210];
...
#[cfg(feature = "cpi")]
pub struct UpdateCollectionAppDataCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct UpdateCollectionAppDataCpiCall<'a> {
    pub accounts: UpdateCollectionAppDataCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait UpdateCollectionAppDataCpi<'info> {
    fn update_collection_app_data<'a>(
        &self,
        accounts: UpdateCollectionAppDataCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.update_collection_app_data_with_remaining_accounts(UpdateCollectionAppDataCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn update_collection_app_data_signed<'a>(
        &self,
        accounts: UpdateCollectionAppDataCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn update_collection_app_data_with_remaining_accounts<'a>(
        &self,
        call: UpdateCollectionAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> UpdateCollectionAppDataCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn update_collection_app_data_with_remaining_accounts<'a>(
        &self,
        call: UpdateCollectionAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let UpdateCollectionAppDataCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[48, 62, 77, 91, 131, 140, 107, 210]);

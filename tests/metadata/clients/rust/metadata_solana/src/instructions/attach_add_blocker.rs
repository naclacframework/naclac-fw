...
pub struct AttachAddBlockerAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_add_blocker<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachAddBlockerAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![62, 52, 101, 253, 225, 25, 171, 202];
...
#[cfg(feature = "cpi")]
pub struct AttachAddBlockerCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachAddBlockerCpiCall<'a> {
    pub accounts: AttachAddBlockerCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachAddBlockerCpi<'info> {
    fn attach_add_blocker<'a>(
        &self,
        accounts: AttachAddBlockerCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_add_blocker_with_remaining_accounts(AttachAddBlockerCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_add_blocker_signed<'a>(
        &self,
        accounts: AttachAddBlockerCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_add_blocker_with_remaining_accounts<'a>(
        &self,
        call: AttachAddBlockerCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachAddBlockerCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_add_blocker_with_remaining_accounts<'a>(
        &self,
        call: AttachAddBlockerCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachAddBlockerCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[62, 52, 101, 253, 225, 25, 171, 202]);

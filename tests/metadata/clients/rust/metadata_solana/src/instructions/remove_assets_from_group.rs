...
pub struct RemoveAssetsFromGroupAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_remove_assets_from_group<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: RemoveAssetsFromGroupAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![172, 158, 180, 12, 76, 178, 64, 141];
...
#[cfg(feature = "cpi")]
pub struct RemoveAssetsFromGroupCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct RemoveAssetsFromGroupCpiCall<'a> {
    pub accounts: RemoveAssetsFromGroupCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait RemoveAssetsFromGroupCpi<'info> {
    fn remove_assets_from_group<'a>(
        &self,
        accounts: RemoveAssetsFromGroupCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.remove_assets_from_group_with_remaining_accounts(RemoveAssetsFromGroupCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn remove_assets_from_group_signed<'a>(
        &self,
        accounts: RemoveAssetsFromGroupCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn remove_assets_from_group_with_remaining_accounts<'a>(
        &self,
        call: RemoveAssetsFromGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> RemoveAssetsFromGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn remove_assets_from_group_with_remaining_accounts<'a>(
        &self,
        call: RemoveAssetsFromGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let RemoveAssetsFromGroupCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[172, 158, 180, 12, 76, 178, 64, 141]);

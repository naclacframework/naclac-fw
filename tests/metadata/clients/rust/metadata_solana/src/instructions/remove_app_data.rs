...
pub struct RemoveAppDataAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_remove_app_data<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: RemoveAppDataAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![165, 106, 192, 15, 24, 23, 114, 161];
...
#[cfg(feature = "cpi")]
pub struct RemoveAppDataCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct RemoveAppDataCpiCall<'a> {
    pub accounts: RemoveAppDataCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait RemoveAppDataCpi<'info> {
    fn remove_app_data<'a>(
        &self,
        accounts: RemoveAppDataCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.remove_app_data_with_remaining_accounts(RemoveAppDataCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn remove_app_data_with_remaining_accounts<'a>(
        &self,
        call: RemoveAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> RemoveAppDataCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn remove_app_data_with_remaining_accounts<'a>(
        &self,
        call: RemoveAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let RemoveAppDataCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[165, 106, 192, 15, 24, 23, 114, 161]);

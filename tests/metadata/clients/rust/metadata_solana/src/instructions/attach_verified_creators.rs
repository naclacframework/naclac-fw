...
pub struct AttachVerifiedCreatorsAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_verified_creators<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachVerifiedCreatorsAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![93, 61, 36, 69, 167, 240, 38, 134];
...
#[cfg(feature = "cpi")]
pub struct AttachVerifiedCreatorsCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachVerifiedCreatorsCpiCall<'a> {
    pub accounts: AttachVerifiedCreatorsCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachVerifiedCreatorsCpi<'info> {
    fn attach_verified_creators<'a>(
        &self,
        accounts: AttachVerifiedCreatorsCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_verified_creators_with_remaining_accounts(AttachVerifiedCreatorsCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_verified_creators_signed<'a>(
        &self,
        accounts: AttachVerifiedCreatorsCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_verified_creators_with_remaining_accounts<'a>(
        &self,
        call: AttachVerifiedCreatorsCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachVerifiedCreatorsCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_verified_creators_with_remaining_accounts<'a>(
        &self,
        call: AttachVerifiedCreatorsCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachVerifiedCreatorsCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[93, 61, 36, 69, 167, 240, 38, 134]);

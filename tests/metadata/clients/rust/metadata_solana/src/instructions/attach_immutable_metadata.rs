...
pub struct AttachImmutableMetadataAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_immutable_metadata<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachImmutableMetadataAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![220, 31, 234, 126, 119, 173, 196, 23];
...
#[cfg(feature = "cpi")]
pub struct AttachImmutableMetadataCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachImmutableMetadataCpiCall<'a> {
    pub accounts: AttachImmutableMetadataCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachImmutableMetadataCpi<'info> {
    fn attach_immutable_metadata<'a>(
        &self,
        accounts: AttachImmutableMetadataCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_immutable_metadata_with_remaining_accounts(AttachImmutableMetadataCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_immutable_metadata_signed<'a>(
        &self,
        accounts: AttachImmutableMetadataCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_immutable_metadata_with_remaining_accounts<'a>(
        &self,
        call: AttachImmutableMetadataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachImmutableMetadataCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_immutable_metadata_with_remaining_accounts<'a>(
        &self,
        call: AttachImmutableMetadataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachImmutableMetadataCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[220, 31, 234, 126, 119, 173, 196, 23]);

...
#[cfg_attr(not(feature = "borsh"), derive(Clone, Debug))]
pub struct UpdateGroupCpiIxArgs {
    pub new_name: crate::sdk_core_cpi::ZcString,
    pub new_uri: crate::sdk_core_cpi::ZcString,
}

#[cfg(feature = "offchain")]
pub struct UpdateGroupAccounts {
    pub group: naclac_client::Address,
...
pub fn build_update_group<'a>(
    ...
    accounts: UpdateGroupAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![9, 242, 1, 110, 91, 22, 172, 97];
    let args = UpdateGroupIxArgs {
        new_name,
        new_uri,
    };
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        .account(naclac_client::AccountMeta { address: accounts.group, is_signer: true, is_writable: true }, "group")
...
#[cfg(feature = "cpi")]
pub struct UpdateGroupCpiAccounts<'a> {
    pub group: crate::sdk_core_cpi::CpiHandleMut<'a>,
...
#[cfg(feature = "cpi")]
pub struct UpdateGroupCpiCall<'a> {
    pub accounts: UpdateGroupCpiAccounts<'a>,
    pub new_name: crate::sdk_core_cpi::ZcString,
    pub new_uri: crate::sdk_core_cpi::ZcString,
...
#[cfg(feature = "cpi")]
pub trait UpdateGroupCpi<'info> {
    fn update_group<'a>(
        &self,
        accounts: UpdateGroupCpiAccounts<'a>,
        new_name: crate::sdk_core_cpi::ZcString,
        new_uri: crate::sdk_core_cpi::ZcString
    ) -> crate::sdk_core_cpi::Result<()> {
        self.update_group_with_remaining_accounts(UpdateGroupCpiCall {
        accounts,
        new_name,
        new_uri,
        signer_seeds: &[],
    ...
    fn update_group_with_remaining_accounts<'a>(
        &self,
        call: UpdateGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> UpdateGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn update_group_with_remaining_accounts<'a>(
        &self,
        call: UpdateGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let UpdateGroupCpiCall { accounts, new_name, new_uri, signer_seeds, remaining_accounts } = call;
        let args = UpdateGroupCpiIxArgs {
            new_name,
            new_uri,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[9, 242, 1, 110, 91, 22, 172, 97]);
        #[cfg(not(feature = "borsh"))]
        {
        ix_data.extend_from_slice(&(args.new_name.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.new_name.as_bytes());
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            let mut idx = 0;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable_signer(accounts.group.info.view.address()));
            idx += 1;
            ...
            let mut h_idx = 0;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.group));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.group.address(), true),

...
pub struct CheckMasterEditionIxArgs {
    pub expected_max_supply: u32,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CheckMasterEditionIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CheckMasterEditionIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CheckMasterEditionCpiIxArgs {
    pub expected_max_supply: u32,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CheckMasterEditionCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CheckMasterEditionCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CheckMasterEditionAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_check_master_edition<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    expected_max_supply: u32,
    accounts: CheckMasterEditionAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![8, 180, 253, 245, 59, 123, 110, 106];
    let args = CheckMasterEditionIxArgs {
        expected_max_supply,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct CheckMasterEditionCpiAccounts<'a> {
    /// SAFETY: read-only; `fetch_collection_master_edition` itself
    /// validates ownership by the real Metaplex Core program before parsing
    /// any bytes.
...
#[cfg(feature = "cpi")]
pub struct CheckMasterEditionCpiCall<'a> {
    pub accounts: CheckMasterEditionCpiAccounts<'a>,
    pub expected_max_supply: u32,
...
#[cfg(feature = "cpi")]
pub trait CheckMasterEditionCpi<'info> {
    fn check_master_edition<'a>(
        &self,
        accounts: CheckMasterEditionCpiAccounts<'a>,
        expected_max_supply: u32
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_master_edition_with_remaining_accounts(CheckMasterEditionCpiCall {
        accounts,
        expected_max_supply,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn check_master_edition_signed<'a>(
        &self,
        accounts: CheckMasterEditionCpiAccounts<'a>,
        expected_max_supply: u32,
        signer_seeds: &[&[&[u8]]]
    ...
    fn check_master_edition_with_remaining_accounts<'a>(
        &self,
        call: CheckMasterEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckMasterEditionCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn check_master_edition_with_remaining_accounts<'a>(
        &self,
        call: CheckMasterEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckMasterEditionCpiCall { accounts, expected_max_supply, signer_seeds, remaining_accounts } = call;
        let args = CheckMasterEditionCpiIxArgs {
            expected_max_supply,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[8, 180, 253, 245, 59, 123, 110, 106]);
        #[cfg(not(feature = "borsh"))]
        {

...
#[cfg(feature = "offchain")]
pub fn build_burn_asset<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: BurnAssetAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![136, 86, 28, 181, 100, 202, 225, 221];
...
#[cfg(feature = "cpi")]
pub struct BurnAssetCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct BurnAssetCpiCall<'a> {
    pub accounts: BurnAssetCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait BurnAssetCpi<'info> {
    fn burn_asset<'a>(
        &self,
        accounts: BurnAssetCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.burn_asset_with_remaining_accounts(BurnAssetCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn burn_asset_with_remaining_accounts<'a>(
        &self,
        call: BurnAssetCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> BurnAssetCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn burn_asset_with_remaining_accounts<'a>(
        &self,
        call: BurnAssetCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let BurnAssetCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[136, 86, 28, 181, 100, 202, 225, 221]);

...
pub struct AttachAutographAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_autograph<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachAutographAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![120, 114, 92, 157, 146, 255, 202, 36];
...
#[cfg(feature = "cpi")]
pub struct AttachAutographCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachAutographCpiCall<'a> {
    pub accounts: AttachAutographCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachAutographCpi<'info> {
    fn attach_autograph<'a>(
        &self,
        accounts: AttachAutographCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_autograph_with_remaining_accounts(AttachAutographCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_autograph_with_remaining_accounts<'a>(
        &self,
        call: AttachAutographCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachAutographCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_autograph_with_remaining_accounts<'a>(
        &self,
        call: AttachAutographCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachAutographCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[120, 114, 92, 157, 146, 255, 202, 36]);

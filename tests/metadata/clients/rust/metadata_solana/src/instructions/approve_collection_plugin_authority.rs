...
pub struct ApproveCollectionPluginAuthorityAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_approve_collection_plugin_authority<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: ApproveCollectionPluginAuthorityAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![133, 16, 213, 70, 106, 10, 123, 252];
...
#[cfg(feature = "cpi")]
pub struct ApproveCollectionPluginAuthorityCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct ApproveCollectionPluginAuthorityCpiCall<'a> {
    pub accounts: ApproveCollectionPluginAuthorityCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait ApproveCollectionPluginAuthorityCpi<'info> {
    fn approve_collection_plugin_authority<'a>(
        &self,
        accounts: ApproveCollectionPluginAuthorityCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.approve_collection_plugin_authority_with_remaining_accounts(ApproveCollectionPluginAuthorityCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn approve_collection_plugin_authority_signed<'a>(
        &self,
        accounts: ApproveCollectionPluginAuthorityCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn approve_collection_plugin_authority_with_remaining_accounts<'a>(
        &self,
        call: ApproveCollectionPluginAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> ApproveCollectionPluginAuthorityCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn approve_collection_plugin_authority_with_remaining_accounts<'a>(
        &self,
        call: ApproveCollectionPluginAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let ApproveCollectionPluginAuthorityCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[133, 16, 213, 70, 106, 10, 123, 252]);

...
pub struct WriteAppDataAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_write_app_data<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: WriteAppDataAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![245, 229, 154, 240, 64, 24, 159, 199];
...
#[cfg(feature = "cpi")]
pub struct WriteAppDataCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct WriteAppDataCpiCall<'a> {
    pub accounts: WriteAppDataCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait WriteAppDataCpi<'info> {
    fn write_app_data<'a>(
        &self,
        accounts: WriteAppDataCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.write_app_data_with_remaining_accounts(WriteAppDataCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn write_app_data_with_remaining_accounts<'a>(
        &self,
        call: WriteAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> WriteAppDataCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn write_app_data_with_remaining_accounts<'a>(
        &self,
        call: WriteAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let WriteAppDataCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[245, 229, 154, 240, 64, 24, 159, 199]);

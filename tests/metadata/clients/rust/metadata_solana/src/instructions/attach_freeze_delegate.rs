...
pub struct AttachFreezeDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_freeze_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachFreezeDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![55, 132, 87, 185, 230, 38, 79, 237];
...
#[cfg(feature = "cpi")]
pub struct AttachFreezeDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachFreezeDelegateCpiCall<'a> {
    pub accounts: AttachFreezeDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachFreezeDelegateCpi<'info> {
    fn attach_freeze_delegate<'a>(
        &self,
        accounts: AttachFreezeDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_freeze_delegate_with_remaining_accounts(AttachFreezeDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_freeze_delegate_signed<'a>(
        &self,
        accounts: AttachFreezeDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn attach_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachFreezeDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: AttachFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachFreezeDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[55, 132, 87, 185, 230, 38, 79, 237]);

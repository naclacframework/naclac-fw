...
pub struct RemoveCollectionAppDataAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_remove_collection_app_data<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: RemoveCollectionAppDataAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![206, 218, 235, 213, 189, 34, 74, 60];
...
#[cfg(feature = "cpi")]
pub struct RemoveCollectionAppDataCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct RemoveCollectionAppDataCpiCall<'a> {
    pub accounts: RemoveCollectionAppDataCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait RemoveCollectionAppDataCpi<'info> {
    fn remove_collection_app_data<'a>(
        &self,
        accounts: RemoveCollectionAppDataCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.remove_collection_app_data_with_remaining_accounts(RemoveCollectionAppDataCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn remove_collection_app_data_signed<'a>(
        &self,
        accounts: RemoveCollectionAppDataCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn remove_collection_app_data_with_remaining_accounts<'a>(
        &self,
        call: RemoveCollectionAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> RemoveCollectionAppDataCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn remove_collection_app_data_with_remaining_accounts<'a>(
        &self,
        call: RemoveCollectionAppDataCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let RemoveCollectionAppDataCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[206, 218, 235, 213, 189, 34, 74, 60]);

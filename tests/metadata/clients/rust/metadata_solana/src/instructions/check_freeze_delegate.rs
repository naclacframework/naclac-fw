...
pub struct CheckFreezeDelegateIxArgs {
    pub expected_frozen: crate::sdk_core_offchain::Bool,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CheckFreezeDelegateIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CheckFreezeDelegateIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CheckFreezeDelegateCpiIxArgs {
    pub expected_frozen: crate::sdk_core_cpi::Bool,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CheckFreezeDelegateCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CheckFreezeDelegateCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CheckFreezeDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_check_freeze_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    expected_frozen: crate::sdk_core_offchain::Bool,
    accounts: CheckFreezeDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![227, 66, 85, 97, 164, 1, 37, 21];
    let args = CheckFreezeDelegateIxArgs {
        expected_frozen,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct CheckFreezeDelegateCpiAccounts<'a> {
    /// SAFETY: read-only; `fetch_asset_freeze_delegate` itself validates
    /// ownership by the real Metaplex Core program before parsing any bytes.
...
#[cfg(feature = "cpi")]
pub struct CheckFreezeDelegateCpiCall<'a> {
    pub accounts: CheckFreezeDelegateCpiAccounts<'a>,
    pub expected_frozen: crate::sdk_core_cpi::Bool,
...
#[cfg(feature = "cpi")]
pub trait CheckFreezeDelegateCpi<'info> {
    fn check_freeze_delegate<'a>(
        &self,
        accounts: CheckFreezeDelegateCpiAccounts<'a>,
        expected_frozen: crate::sdk_core_cpi::Bool
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_freeze_delegate_with_remaining_accounts(CheckFreezeDelegateCpiCall {
        accounts,
        expected_frozen,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn check_freeze_delegate_signed<'a>(
        &self,
        accounts: CheckFreezeDelegateCpiAccounts<'a>,
        expected_frozen: crate::sdk_core_cpi::Bool,
        signer_seeds: &[&[&[u8]]]
    ...
    fn check_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: CheckFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckFreezeDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn check_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: CheckFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckFreezeDelegateCpiCall { accounts, expected_frozen, signer_seeds, remaining_accounts } = call;
        let args = CheckFreezeDelegateCpiIxArgs {
            expected_frozen,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[227, 66, 85, 97, 164, 1, 37, 21]);
        #[cfg(not(feature = "borsh"))]
        {

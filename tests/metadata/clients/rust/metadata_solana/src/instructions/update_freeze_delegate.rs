...
pub struct UpdateFreezeDelegateAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_update_freeze_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: UpdateFreezeDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![195, 199, 116, 109, 255, 20, 52, 14];
...
#[cfg(feature = "cpi")]
pub struct UpdateFreezeDelegateCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct UpdateFreezeDelegateCpiCall<'a> {
    pub accounts: UpdateFreezeDelegateCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait UpdateFreezeDelegateCpi<'info> {
    fn update_freeze_delegate<'a>(
        &self,
        accounts: UpdateFreezeDelegateCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.update_freeze_delegate_with_remaining_accounts(UpdateFreezeDelegateCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn update_freeze_delegate_signed<'a>(
        &self,
        accounts: UpdateFreezeDelegateCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn update_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: UpdateFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> UpdateFreezeDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn update_freeze_delegate_with_remaining_accounts<'a>(
        &self,
        call: UpdateFreezeDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let UpdateFreezeDelegateCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[195, 199, 116, 109, 255, 20, 52, 14]);

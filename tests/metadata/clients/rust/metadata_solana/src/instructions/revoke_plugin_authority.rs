...
pub struct RevokePluginAuthorityAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_revoke_plugin_authority<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: RevokePluginAuthorityAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![230, 107, 240, 174, 80, 142, 61, 36];
...
#[cfg(feature = "cpi")]
pub struct RevokePluginAuthorityCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct RevokePluginAuthorityCpiCall<'a> {
    pub accounts: RevokePluginAuthorityCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait RevokePluginAuthorityCpi<'info> {
    fn revoke_plugin_authority<'a>(
        &self,
        accounts: RevokePluginAuthorityCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.revoke_plugin_authority_with_remaining_accounts(RevokePluginAuthorityCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn revoke_plugin_authority_signed<'a>(
        &self,
        accounts: RevokePluginAuthorityCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn revoke_plugin_authority_with_remaining_accounts<'a>(
        &self,
        call: RevokePluginAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> RevokePluginAuthorityCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn revoke_plugin_authority_with_remaining_accounts<'a>(
        &self,
        call: RevokePluginAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let RevokePluginAuthorityCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[230, 107, 240, 174, 80, 142, 61, 36]);

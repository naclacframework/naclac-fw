...
pub struct AddAssetsToGroupAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_add_assets_to_group<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AddAssetsToGroupAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![83, 187, 113, 48, 20, 247, 48, 34];
...
#[cfg(feature = "cpi")]
pub struct AddAssetsToGroupCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AddAssetsToGroupCpiCall<'a> {
    pub accounts: AddAssetsToGroupCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AddAssetsToGroupCpi<'info> {
    fn add_assets_to_group<'a>(
        &self,
        accounts: AddAssetsToGroupCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.add_assets_to_group_with_remaining_accounts(AddAssetsToGroupCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn add_assets_to_group_signed<'a>(
        &self,
        accounts: AddAssetsToGroupCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn add_assets_to_group_with_remaining_accounts<'a>(
        &self,
        call: AddAssetsToGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AddAssetsToGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn add_assets_to_group_with_remaining_accounts<'a>(
        &self,
        call: AddAssetsToGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AddAssetsToGroupCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[83, 187, 113, 48, 20, 247, 48, 34]);

...
#[cfg(feature = "offchain")]
pub fn build_close_group<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: CloseGroupAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![40, 187, 201, 187, 18, 194, 122, 232];
...
#[cfg(feature = "cpi")]
pub struct CloseGroupCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CloseGroupCpiCall<'a> {
    pub accounts: CloseGroupCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait CloseGroupCpi<'info> {
    fn close_group<'a>(
        &self,
        accounts: CloseGroupCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.close_group_with_remaining_accounts(CloseGroupCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn close_group_with_remaining_accounts<'a>(
        &self,
        call: CloseGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CloseGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn close_group_with_remaining_accounts<'a>(
        &self,
        call: CloseGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CloseGroupCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[40, 187, 201, 187, 18, 194, 122, 232]);

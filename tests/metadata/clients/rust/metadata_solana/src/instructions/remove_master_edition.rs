...
pub struct RemoveMasterEditionAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_remove_master_edition<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: RemoveMasterEditionAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![53, 66, 171, 104, 64, 203, 152, 135];
...
#[cfg(feature = "cpi")]
pub struct RemoveMasterEditionCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct RemoveMasterEditionCpiCall<'a> {
    pub accounts: RemoveMasterEditionCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait RemoveMasterEditionCpi<'info> {
    fn remove_master_edition<'a>(
        &self,
        accounts: RemoveMasterEditionCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.remove_master_edition_with_remaining_accounts(RemoveMasterEditionCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn remove_master_edition_signed<'a>(
        &self,
        accounts: RemoveMasterEditionCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn remove_master_edition_with_remaining_accounts<'a>(
        &self,
        call: RemoveMasterEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> RemoveMasterEditionCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn remove_master_edition_with_remaining_accounts<'a>(
        &self,
        call: RemoveMasterEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let RemoveMasterEditionCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[53, 66, 171, 104, 64, 203, 152, 135]);

...
pub struct RemoveGroupsFromGroupAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_remove_groups_from_group<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: RemoveGroupsFromGroupAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![251, 98, 149, 67, 60, 147, 135, 138];
...
#[cfg(feature = "cpi")]
pub struct RemoveGroupsFromGroupCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct RemoveGroupsFromGroupCpiCall<'a> {
    pub accounts: RemoveGroupsFromGroupCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait RemoveGroupsFromGroupCpi<'info> {
    fn remove_groups_from_group<'a>(
        &self,
        accounts: RemoveGroupsFromGroupCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.remove_groups_from_group_with_remaining_accounts(RemoveGroupsFromGroupCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn remove_groups_from_group_signed<'a>(
        &self,
        accounts: RemoveGroupsFromGroupCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn remove_groups_from_group_with_remaining_accounts<'a>(
        &self,
        call: RemoveGroupsFromGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> RemoveGroupsFromGroupCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn remove_groups_from_group_with_remaining_accounts<'a>(
        &self,
        call: RemoveGroupsFromGroupCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let RemoveGroupsFromGroupCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[251, 98, 149, 67, 60, 147, 135, 138]);

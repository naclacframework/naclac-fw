...
pub struct AttachEditionAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_attach_edition<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: AttachEditionAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![46, 41, 117, 235, 219, 100, 210, 231];
...
#[cfg(feature = "cpi")]
pub struct AttachEditionCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct AttachEditionCpiCall<'a> {
    pub accounts: AttachEditionCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait AttachEditionCpi<'info> {
    fn attach_edition<'a>(
        &self,
        accounts: AttachEditionCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.attach_edition_with_remaining_accounts(AttachEditionCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn attach_edition_with_remaining_accounts<'a>(
        &self,
        call: AttachEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> AttachEditionCpi<'info> for crate::sdk_core_cpi::Program<crate::MetadataSolana> {
    fn attach_edition_with_remaining_accounts<'a>(
        &self,
        call: AttachEditionCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let AttachEditionCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[46, 41, 117, 235, 219, 100, 210, 231]);

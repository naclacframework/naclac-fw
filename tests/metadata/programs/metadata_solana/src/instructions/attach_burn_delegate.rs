...
/// Attaches a BurnDelegate plugin to an existing Asset via
/// `naclac_metadata::attach_burn_delegate_signed`.
#[derive(Accounts)]
pub struct AttachBurnDelegate {
    #[account(mut)]
    pub asset: Signer,

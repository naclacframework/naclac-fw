...
pub struct ResizeGrowableIxArgs {
    pub new_space: u64,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for ResizeGrowableIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for ResizeGrowableIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct ResizeGrowableCpiIxArgs {
    pub new_space: u64,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for ResizeGrowableCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for ResizeGrowableCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct ResizeGrowableAccounts {
    pub payer: naclac_client::Address,
    pub growable: naclac_client::Address,
    pub system_program: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_resize_growable<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    new_space: u64,
    accounts: ResizeGrowableAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![166, 0, 216, 224, 238, 57, 30, 44];
    let args = ResizeGrowableIxArgs {
        new_space,
    };
    #[cfg(not(feature = "borsh"))]
    {
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.growable, is_signer: false, is_writable: true }, "growable")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct ResizeGrowableCpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub growable: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct ResizeGrowableCpiCall<'a> {
    pub accounts: ResizeGrowableCpiAccounts<'a>,
    pub new_space: u64,
...
#[cfg(feature = "cpi")]
pub trait ResizeGrowableCpi<'info> {
    fn resize_growable<'a>(
        &self,
        accounts: ResizeGrowableCpiAccounts<'a>,
        new_space: u64
    ) -> crate::sdk_core_cpi::Result<()> {
        self.resize_growable_with_remaining_accounts(ResizeGrowableCpiCall {
        accounts,
        new_space,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn resize_growable_with_remaining_accounts<'a>(
        &self,
        call: ResizeGrowableCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> ResizeGrowableCpi<'info> for crate::sdk_core_cpi::Program<crate::ReallocBorsh> {
    fn resize_growable_with_remaining_accounts<'a>(
        &self,
        call: ResizeGrowableCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let ResizeGrowableCpiCall { accounts, new_space, signer_seeds, remaining_accounts } = call;
        let args = ResizeGrowableCpiIxArgs {
            new_space,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[166, 0, 216, 224, 238, 57, 30, 44]);
        #[cfg(not(feature = "borsh"))]
        {
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.growable.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.growable));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.growable.address(), false),

...
pub struct InitGrowableAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_init_growable<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitGrowableAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![171, 24, 231, 25, 60, 46, 156, 148];
...
#[cfg(feature = "cpi")]
pub struct InitGrowableCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitGrowableCpiCall<'a> {
    pub accounts: InitGrowableCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitGrowableCpi<'info> {
    fn init_growable<'a>(
        &self,
        accounts: InitGrowableCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_growable_with_remaining_accounts(InitGrowableCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_growable_with_remaining_accounts<'a>(
        &self,
        call: InitGrowableCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitGrowableCpi<'info> for crate::sdk_core_cpi::Program<crate::ReallocBorsh> {
    fn init_growable_with_remaining_accounts<'a>(
        &self,
        call: InitGrowableCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitGrowableCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[171, 24, 231, 25, 60, 46, 156, 148]);

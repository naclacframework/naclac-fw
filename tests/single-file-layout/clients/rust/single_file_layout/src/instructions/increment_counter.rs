...
pub fn build_increment_counter<'a>(
    ...
    let ix_data = crate::sdk_core::vec![16, 125, 2, 171, 73, 24, 207, 229];
...
pub struct IncrementCounterCpiAccounts<'a> {
    pub counter: crate::sdk_core::CpiHandleMut<'a>,
}
...
pub trait IncrementCounterCpi<'info> {
    fn increment_counter<'a>(
        ...
        self.increment_counter_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn increment_counter_signed<'a>(
        ...
        self.increment_counter_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> IncrementCounterCpi<'info> for crate::sdk_core::Program<crate::SingleFileLayout> {
    fn increment_counter_with_remaining_accounts<'a>(
        &self,
        accounts: IncrementCounterCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            let mut idx = 0;
            metas_arr[idx].write(crate::sdk_core::pinocchio::instruction::InstructionAccount::writable(accounts.counter.info.view.address()));
            idx += 1;
            ...
            let mut h_idx = 0;
            handles_arr[h_idx].write(crate::sdk_core::CpiHandle::from(accounts.counter));
            h_idx += 1;

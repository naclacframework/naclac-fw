...
pub fn build_init_counter<'a>(
    ...
    let ix_data = crate::sdk_core::vec![247, 168, 146, 45, 125, 26, 142, 80];
...
pub trait InitCounterCpi<'info> {
    fn init_counter<'a>(
        ...
        self.init_counter_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn init_counter_signed<'a>(
        ...
        self.init_counter_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> InitCounterCpi<'info> for crate::sdk_core::Program<crate::SingleFileLayout> {
    fn init_counter_with_remaining_accounts<'a>(
        &self,
        accounts: InitCounterCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],

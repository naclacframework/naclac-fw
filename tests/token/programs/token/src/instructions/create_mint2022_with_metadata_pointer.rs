...
#[derive(Accounts)]
#[instruction(args: CreateMint2022WithMetadataPointerArgs)]
pub struct CreateMint2022WithMetadataPointer {
    #[account(mut)]
    pub payer: Signer,
...
pub fn create_mint2022_with_metadata_pointer(
    ...
    let rent = Rent::get()?;
    let lamports = rent.try_minimum_balance(MINT_WITH_METADATA_POINTER_SPACE as usize)?;

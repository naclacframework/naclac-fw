...
#[derive(Accounts)]
#[instruction(args: CreateMint2022WithGroupPointerArgs)]
pub struct CreateMint2022WithGroupPointer {
    #[account(mut)]
    pub payer: Signer,
...
/// 4-byte TLV header + 64-byte `GroupPointer` value.
...
pub fn create_mint2022_with_group_pointer(
    ...
    let rent = Rent::get()?;
    let lamports = rent.try_minimum_balance(MINT_WITH_GROUP_POINTER_SPACE as usize)?;

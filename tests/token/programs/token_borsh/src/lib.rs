...
pub mod token_borsh {
    ...
    pub fn create_mint2022_init_if_needed(
        ctx: Context<CreateMint2022InitIfNeeded>,
        id: u64,
        mint_bump: u8,
        decimals: u8,
    ) -> Result {
        create_mint2022_init_if_needed::create_mint2022_init_if_needed(ctx, id, mint_bump, decimals)
    }
    ...
    pub fn exercise_transfer_checked_with_hook(
        ...
        exercise_transfer_checked_with_hook::exercise_transfer_checked_with_hook(ctx, amount, decimals)
    }

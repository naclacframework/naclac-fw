...
#[cfg(feature = "cpi")]
impl<'info> CreateMintCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn create_mint_with_remaining_accounts<'a>(
        &self,
        call: CreateMintCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateMintCpiCall { accounts, id, mint_bump, decimals, signer_seeds, remaining_accounts } = call;

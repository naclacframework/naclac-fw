...
pub fn build_check_scaled_ui_amount_config<'a>(
    ...
    #[cfg(not(feature = "borsh"))]
    {
        ...
        ix_data.extend_from_slice(crate::sdk_core_offchain::bytemuck::bytes_of(&args.expected_multiplier_bits));
    }
    #[cfg(feature = "borsh")]
    {
...
impl<'info> CheckScaledUiAmountConfigCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_scaled_ui_amount_config_with_remaining_accounts<'a>(
        ...
        ix_data.extend_from_slice(crate::sdk_core_cpi::bytemuck::bytes_of(&args.expected_multiplier_bits));
        }
        #[cfg(feature = "borsh")]
        {

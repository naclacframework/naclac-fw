...
pub struct CheckScaledUiAmountConfigIxArgs {
...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CheckScaledUiAmountConfigIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CheckScaledUiAmountConfigIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CheckScaledUiAmountConfigCpiIxArgs {
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CheckScaledUiAmountConfigCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CheckScaledUiAmountConfigCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CheckScaledUiAmountConfigAccounts {
    pub mint: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_check_scaled_ui_amount_config<'a>(
    ...
    accounts: CheckScaledUiAmountConfigAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![202, 110, 5, 227, 53, 32, 96, 126];
    let args = CheckScaledUiAmountConfigIxArgs {
        expected_authority,
...
#[cfg(feature = "cpi")]
pub struct CheckScaledUiAmountConfigCpiAccounts<'a> {
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckScaledUiAmountConfigCpiCall<'a> {
    pub accounts: CheckScaledUiAmountConfigCpiAccounts<'a>,
    pub expected_authority: Option<crate::sdk_core_cpi::Address>,
    pub expected_multiplier_bits: u64,
...
#[cfg(feature = "cpi")]
pub trait CheckScaledUiAmountConfigCpi<'info> {
    fn check_scaled_ui_amount_config<'a>(
        &self,
        accounts: CheckScaledUiAmountConfigCpiAccounts<'a>,
        expected_authority: Option<crate::sdk_core_cpi::Address>,
        expected_multiplier_bits: u64
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_scaled_ui_amount_config_with_remaining_accounts(CheckScaledUiAmountConfigCpiCall {
        accounts,
        expected_authority,
        expected_multiplier_bits,
        signer_seeds: &[],
    ...
    fn check_scaled_ui_amount_config_signed<'a>(
        &self,
        accounts: CheckScaledUiAmountConfigCpiAccounts<'a>,
        expected_authority: Option<crate::sdk_core_cpi::Address>,
        expected_multiplier_bits: u64,
    ...
    fn check_scaled_ui_amount_config_with_remaining_accounts<'a>(
        &self,
        call: CheckScaledUiAmountConfigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckScaledUiAmountConfigCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_scaled_ui_amount_config_with_remaining_accounts<'a>(
        &self,
        call: CheckScaledUiAmountConfigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckScaledUiAmountConfigCpiCall { accounts, expected_authority, expected_multiplier_bits, signer_seeds, remaining_accounts } = call;
        let args = CheckScaledUiAmountConfigCpiIxArgs {
            expected_authority,
            expected_multiplier_bits,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[202, 110, 5, 227, 53, 32, 96, 126]);
        #[cfg(not(feature = "borsh"))]
        {

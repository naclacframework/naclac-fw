...
pub struct CreateMintWithFreezeIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CreateMintWithFreezeIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CreateMintWithFreezeIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CreateMintWithFreezeCpiIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CreateMintWithFreezeCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CreateMintWithFreezeCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CreateMintWithFreezeAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_create_mint_with_freeze<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    id: u64,
    mint_bump: u8,
    decimals: u8,
    accounts: CreateMintWithFreezeAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![196, 21, 137, 205, 211, 246, 135, 220];
    let args = CreateMintWithFreezeIxArgs {
        id,
        mint_bump,
        decimals,
    };
...
#[cfg(feature = "cpi")]
pub struct CreateMintWithFreezeCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CreateMintWithFreezeCpiCall<'a> {
    pub accounts: CreateMintWithFreezeCpiAccounts<'a>,
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
...
#[cfg(feature = "cpi")]
pub trait CreateMintWithFreezeCpi<'info> {
    fn create_mint_with_freeze<'a>(
        &self,
        accounts: CreateMintWithFreezeCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
        decimals: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_mint_with_freeze_with_remaining_accounts(CreateMintWithFreezeCpiCall {
        accounts,
        id,
        mint_bump,
        decimals,
    ...
    fn create_mint_with_freeze_signed<'a>(
        &self,
        accounts: CreateMintWithFreezeCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
    ...
    fn create_mint_with_freeze_with_remaining_accounts<'a>(
        &self,
        call: CreateMintWithFreezeCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateMintWithFreezeCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn create_mint_with_freeze_with_remaining_accounts<'a>(
        &self,
        call: CreateMintWithFreezeCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateMintWithFreezeCpiCall { accounts, id, mint_bump, decimals, signer_seeds, remaining_accounts } = call;
        let args = CreateMintWithFreezeCpiIxArgs {
            id,
            mint_bump,
            decimals,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[196, 21, 137, 205, 211, 246, 135, 220]);
        #[cfg(not(feature = "borsh"))]
        {

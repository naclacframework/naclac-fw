...
#[cfg(feature = "offchain")]
pub fn build_check_permanent_delegate<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    expected_delegate: Option<crate::sdk_core_offchain::Address>,
    accounts: CheckPermanentDelegateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![245, 167, 175, 200, 221, 164, 191, 228];
    let args = CheckPermanentDelegateIxArgs {
        expected_delegate,
    };
...
#[cfg(feature = "cpi")]
pub struct CheckPermanentDelegateCpiAccounts<'a> {
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckPermanentDelegateCpiCall<'a> {
    pub accounts: CheckPermanentDelegateCpiAccounts<'a>,
    pub expected_delegate: Option<crate::sdk_core_cpi::Address>,
...
#[cfg(feature = "cpi")]
pub trait CheckPermanentDelegateCpi<'info> {
    fn check_permanent_delegate<'a>(
        &self,
        accounts: CheckPermanentDelegateCpiAccounts<'a>,
        expected_delegate: Option<crate::sdk_core_cpi::Address>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_permanent_delegate_with_remaining_accounts(CheckPermanentDelegateCpiCall {
        accounts,
        expected_delegate,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn check_permanent_delegate_signed<'a>(
        &self,
        accounts: CheckPermanentDelegateCpiAccounts<'a>,
        expected_delegate: Option<crate::sdk_core_cpi::Address>,
        signer_seeds: &[&[&[u8]]]
    ...
    fn check_permanent_delegate_with_remaining_accounts<'a>(
        &self,
        call: CheckPermanentDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckPermanentDelegateCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_permanent_delegate_with_remaining_accounts<'a>(
        &self,
        call: CheckPermanentDelegateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckPermanentDelegateCpiCall { accounts, expected_delegate, signer_seeds, remaining_accounts } = call;
        let args = CheckPermanentDelegateCpiIxArgs {
            expected_delegate,
        };

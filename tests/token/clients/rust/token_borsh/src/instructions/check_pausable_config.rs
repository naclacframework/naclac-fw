...
#[cfg(feature = "offchain")]
pub fn build_check_pausable_config<'a>(
    ...
    expected_paused: u8,
    accounts: CheckPausableConfigAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![248, 215, 7, 252, 136, 203, 211, 202];
    let args = CheckPausableConfigIxArgs {
        expected_authority,
        expected_paused,
    };
    #[cfg(not(feature = "borsh"))]
...
#[cfg(feature = "cpi")]
pub struct CheckPausableConfigCpiAccounts<'a> {
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckPausableConfigCpiCall<'a> {
    pub accounts: CheckPausableConfigCpiAccounts<'a>,
    pub expected_authority: Option<crate::sdk_core_cpi::Address>,
    pub expected_paused: u8,
...
#[cfg(feature = "cpi")]
pub trait CheckPausableConfigCpi<'info> {
    fn check_pausable_config<'a>(
        &self,
        accounts: CheckPausableConfigCpiAccounts<'a>,
        expected_authority: Option<crate::sdk_core_cpi::Address>,
        expected_paused: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_pausable_config_with_remaining_accounts(CheckPausableConfigCpiCall {
        accounts,
        expected_authority,
        expected_paused,
        signer_seeds: &[],
    ...
    fn check_pausable_config_signed<'a>(
        &self,
        accounts: CheckPausableConfigCpiAccounts<'a>,
        expected_authority: Option<crate::sdk_core_cpi::Address>,
        expected_paused: u8,
    ...
    fn check_pausable_config_with_remaining_accounts<'a>(
        &self,
        call: CheckPausableConfigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckPausableConfigCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_pausable_config_with_remaining_accounts<'a>(
        &self,
        call: CheckPausableConfigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckPausableConfigCpiCall { accounts, expected_authority, expected_paused, signer_seeds, remaining_accounts } = call;
        let args = CheckPausableConfigCpiIxArgs {
            expected_authority,
            expected_paused,
        };

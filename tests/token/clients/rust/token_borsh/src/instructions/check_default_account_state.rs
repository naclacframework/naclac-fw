...
pub struct CheckDefaultAccountStateIxArgs {
    pub expected_state: u8,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CheckDefaultAccountStateIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CheckDefaultAccountStateIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CheckDefaultAccountStateCpiIxArgs {
    pub expected_state: u8,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CheckDefaultAccountStateCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CheckDefaultAccountStateCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CheckDefaultAccountStateAccounts {
    pub mint: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_check_default_account_state<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    expected_state: u8,
    accounts: CheckDefaultAccountStateAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![255, 107, 101, 2, 68, 186, 61, 6];
    let args = CheckDefaultAccountStateIxArgs {
        expected_state,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct CheckDefaultAccountStateCpiAccounts<'a> {
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckDefaultAccountStateCpiCall<'a> {
    pub accounts: CheckDefaultAccountStateCpiAccounts<'a>,
    pub expected_state: u8,
...
#[cfg(feature = "cpi")]
pub trait CheckDefaultAccountStateCpi<'info> {
    fn check_default_account_state<'a>(
        &self,
        accounts: CheckDefaultAccountStateCpiAccounts<'a>,
        expected_state: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_default_account_state_with_remaining_accounts(CheckDefaultAccountStateCpiCall {
        accounts,
        expected_state,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn check_default_account_state_signed<'a>(
        &self,
        accounts: CheckDefaultAccountStateCpiAccounts<'a>,
        expected_state: u8,
        signer_seeds: &[&[&[u8]]]
    ...
    fn check_default_account_state_with_remaining_accounts<'a>(
        &self,
        call: CheckDefaultAccountStateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckDefaultAccountStateCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_default_account_state_with_remaining_accounts<'a>(
        &self,
        call: CheckDefaultAccountStateCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckDefaultAccountStateCpiCall { accounts, expected_state, signer_seeds, remaining_accounts } = call;
        let args = CheckDefaultAccountStateCpiIxArgs {
            expected_state,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[255, 107, 101, 2, 68, 186, 61, 6]);
        #[cfg(not(feature = "borsh"))]
        {

...
#[cfg(feature = "offchain")]
pub fn build_check_interest_bearing_mint<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    args: crate::types::CheckInterestBearingMintArgs,
    accounts: CheckInterestBearingMintAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![24, 252, 8, 137, 207, 158, 50, 33];
    let args = CheckInterestBearingMintIxArgs {
        args,
    };
...
#[cfg(feature = "cpi")]
pub struct CheckInterestBearingMintCpiAccounts<'a> {
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckInterestBearingMintCpiCall<'a> {
    pub accounts: CheckInterestBearingMintCpiAccounts<'a>,
    pub args: crate::types::CheckInterestBearingMintArgsCpi,
...
#[cfg(feature = "cpi")]
pub trait CheckInterestBearingMintCpi<'info> {
    fn check_interest_bearing_mint<'a>(
        &self,
        accounts: CheckInterestBearingMintCpiAccounts<'a>,
        args: crate::types::CheckInterestBearingMintArgsCpi
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_interest_bearing_mint_with_remaining_accounts(CheckInterestBearingMintCpiCall {
        accounts,
        args,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn check_interest_bearing_mint_signed<'a>(
        &self,
        accounts: CheckInterestBearingMintCpiAccounts<'a>,
        args: crate::types::CheckInterestBearingMintArgsCpi,
        signer_seeds: &[&[&[u8]]]
    ...
    fn check_interest_bearing_mint_with_remaining_accounts<'a>(
        &self,
        call: CheckInterestBearingMintCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckInterestBearingMintCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_interest_bearing_mint_with_remaining_accounts<'a>(
        &self,
        call: CheckInterestBearingMintCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckInterestBearingMintCpiCall { accounts, args, signer_seeds, remaining_accounts } = call;
        let args = CheckInterestBearingMintCpiIxArgs {
            args,
        };

...
pub struct CheckPermissionedBurnIxArgs {
    pub expected_authority: Option<crate::sdk_core_offchain::Address>,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CheckPermissionedBurnIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CheckPermissionedBurnIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CheckPermissionedBurnCpiIxArgs {
    pub expected_authority: Option<crate::sdk_core_cpi::Address>,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CheckPermissionedBurnCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CheckPermissionedBurnCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CheckPermissionedBurnAccounts {
    pub mint: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_check_permissioned_burn<'a>(
    ...
    accounts: CheckPermissionedBurnAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![52, 89, 178, 224, 81, 194, 237, 170];
    let args = CheckPermissionedBurnIxArgs {
        expected_authority,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct CheckPermissionedBurnCpiAccounts<'a> {
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckPermissionedBurnCpiCall<'a> {
    pub accounts: CheckPermissionedBurnCpiAccounts<'a>,
    pub expected_authority: Option<crate::sdk_core_cpi::Address>,
...
#[cfg(feature = "cpi")]
pub trait CheckPermissionedBurnCpi<'info> {
    fn check_permissioned_burn<'a>(
        &self,
        accounts: CheckPermissionedBurnCpiAccounts<'a>,
        expected_authority: Option<crate::sdk_core_cpi::Address>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_permissioned_burn_with_remaining_accounts(CheckPermissionedBurnCpiCall {
        accounts,
        expected_authority,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn check_permissioned_burn_signed<'a>(
        &self,
        accounts: CheckPermissionedBurnCpiAccounts<'a>,
        expected_authority: Option<crate::sdk_core_cpi::Address>,
        signer_seeds: &[&[&[u8]]]
    ...
    fn check_permissioned_burn_with_remaining_accounts<'a>(
        &self,
        call: CheckPermissionedBurnCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckPermissionedBurnCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_permissioned_burn_with_remaining_accounts<'a>(
        &self,
        call: CheckPermissionedBurnCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckPermissionedBurnCpiCall { accounts, expected_authority, signer_seeds, remaining_accounts } = call;
        let args = CheckPermissionedBurnCpiIxArgs {
            expected_authority,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[52, 89, 178, 224, 81, 194, 237, 170]);
        #[cfg(not(feature = "borsh"))]
        {

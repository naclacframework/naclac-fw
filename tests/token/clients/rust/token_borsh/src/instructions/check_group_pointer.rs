...
#[cfg(feature = "offchain")]
pub fn build_check_group_pointer<'a>(
    ...
    expected_group_address: Option<crate::sdk_core_offchain::Address>,
    accounts: CheckGroupPointerAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![254, 151, 35, 152, 242, 0, 4, 180];
    let args = CheckGroupPointerIxArgs {
        expected_authority,
...
#[cfg(feature = "cpi")]
pub struct CheckGroupPointerCpiAccounts<'a> {
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckGroupPointerCpiCall<'a> {
    pub accounts: CheckGroupPointerCpiAccounts<'a>,
    pub expected_authority: Option<crate::sdk_core_cpi::Address>,
    pub expected_group_address: Option<crate::sdk_core_cpi::Address>,
...
#[cfg(feature = "cpi")]
pub trait CheckGroupPointerCpi<'info> {
    fn check_group_pointer<'a>(
        &self,
        accounts: CheckGroupPointerCpiAccounts<'a>,
        expected_authority: Option<crate::sdk_core_cpi::Address>,
        expected_group_address: Option<crate::sdk_core_cpi::Address>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_group_pointer_with_remaining_accounts(CheckGroupPointerCpiCall {
        accounts,
        expected_authority,
        expected_group_address,
        signer_seeds: &[],
    ...
    fn check_group_pointer_signed<'a>(
        &self,
        accounts: CheckGroupPointerCpiAccounts<'a>,
        expected_authority: Option<crate::sdk_core_cpi::Address>,
        expected_group_address: Option<crate::sdk_core_cpi::Address>,
    ...
    fn check_group_pointer_with_remaining_accounts<'a>(
        &self,
        call: CheckGroupPointerCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckGroupPointerCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_group_pointer_with_remaining_accounts<'a>(
        &self,
        call: CheckGroupPointerCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckGroupPointerCpiCall { accounts, expected_authority, expected_group_address, signer_seeds, remaining_accounts } = call;
        let args = CheckGroupPointerCpiIxArgs {
            expected_authority,
            expected_group_address,
        };

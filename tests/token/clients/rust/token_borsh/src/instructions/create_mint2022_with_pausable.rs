...
pub struct CreateMint2022WithPausableIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CreateMint2022WithPausableIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CreateMint2022WithPausableIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CreateMint2022WithPausableCpiIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CreateMint2022WithPausableCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CreateMint2022WithPausableCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CreateMint2022WithPausableAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_create_mint2022_with_pausable<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    id: u64,
    mint_bump: u8,
    decimals: u8,
    accounts: CreateMint2022WithPausableAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![5, 234, 25, 249, 211, 112, 86, 17];
    let args = CreateMint2022WithPausableIxArgs {
        id,
        mint_bump,
        decimals,
    };
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022WithPausableCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022WithPausableCpiCall<'a> {
    pub accounts: CreateMint2022WithPausableCpiAccounts<'a>,
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
...
#[cfg(feature = "cpi")]
pub trait CreateMint2022WithPausableCpi<'info> {
    fn create_mint2022_with_pausable<'a>(
        &self,
        accounts: CreateMint2022WithPausableCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
        decimals: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_mint2022_with_pausable_with_remaining_accounts(CreateMint2022WithPausableCpiCall {
        accounts,
        id,
        mint_bump,
        decimals,
    ...
    fn create_mint2022_with_pausable_signed<'a>(
        &self,
        accounts: CreateMint2022WithPausableCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
    ...
    fn create_mint2022_with_pausable_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022WithPausableCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateMint2022WithPausableCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn create_mint2022_with_pausable_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022WithPausableCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateMint2022WithPausableCpiCall { accounts, id, mint_bump, decimals, signer_seeds, remaining_accounts } = call;
        let args = CreateMint2022WithPausableCpiIxArgs {
            id,
            mint_bump,
            decimals,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[5, 234, 25, 249, 211, 112, 86, 17]);
        #[cfg(not(feature = "borsh"))]
        {

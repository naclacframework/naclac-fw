...
pub struct CheckMemoTransferIxArgs {
    pub expected_present: u8,
    pub expected_required: u8,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CheckMemoTransferIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CheckMemoTransferIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CheckMemoTransferCpiIxArgs {
    pub expected_present: u8,
    pub expected_required: u8,
}
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CheckMemoTransferCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CheckMemoTransferCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CheckMemoTransferAccounts {
    pub vault: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_check_memo_transfer<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    expected_present: u8,
    expected_required: u8,
    accounts: CheckMemoTransferAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![111, 90, 98, 4, 185, 241, 187, 85];
    let args = CheckMemoTransferIxArgs {
        expected_present,
        expected_required,
    };
    #[cfg(not(feature = "borsh"))]
...
#[cfg(feature = "cpi")]
pub struct CheckMemoTransferCpiAccounts<'a> {
    pub vault: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckMemoTransferCpiCall<'a> {
    pub accounts: CheckMemoTransferCpiAccounts<'a>,
    pub expected_present: u8,
    pub expected_required: u8,
...
#[cfg(feature = "cpi")]
pub trait CheckMemoTransferCpi<'info> {
    fn check_memo_transfer<'a>(
        &self,
        accounts: CheckMemoTransferCpiAccounts<'a>,
        expected_present: u8,
        expected_required: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_memo_transfer_with_remaining_accounts(CheckMemoTransferCpiCall {
        accounts,
        expected_present,
        expected_required,
        signer_seeds: &[],
    ...
    fn check_memo_transfer_signed<'a>(
        &self,
        accounts: CheckMemoTransferCpiAccounts<'a>,
        expected_present: u8,
        expected_required: u8,
    ...
    fn check_memo_transfer_with_remaining_accounts<'a>(
        &self,
        call: CheckMemoTransferCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckMemoTransferCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_memo_transfer_with_remaining_accounts<'a>(
        &self,
        call: CheckMemoTransferCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckMemoTransferCpiCall { accounts, expected_present, expected_required, signer_seeds, remaining_accounts } = call;
        let args = CheckMemoTransferCpiIxArgs {
            expected_present,
            expected_required,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[111, 90, 98, 4, 185, 241, 187, 85]);
        #[cfg(not(feature = "borsh"))]
        {

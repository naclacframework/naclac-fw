...
pub struct CheckVaultProgramAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_check_vault_program<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: CheckVaultProgramAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![11, 24, 214, 180, 243, 235, 169, 238];
...
#[cfg(feature = "cpi")]
pub struct CheckVaultProgramCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CheckVaultProgramCpiCall<'a> {
    pub accounts: CheckVaultProgramCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait CheckVaultProgramCpi<'info> {
    fn check_vault_program<'a>(
        &self,
        accounts: CheckVaultProgramCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_vault_program_with_remaining_accounts(CheckVaultProgramCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn check_vault_program_signed<'a>(
        &self,
        accounts: CheckVaultProgramCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn check_vault_program_with_remaining_accounts<'a>(
        &self,
        call: CheckVaultProgramCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckVaultProgramCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn check_vault_program_with_remaining_accounts<'a>(
        &self,
        call: CheckVaultProgramCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckVaultProgramCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[11, 24, 214, 180, 243, 235, 169, 238]);

...
pub struct CreateMint2022InitIfNeededIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CreateMint2022InitIfNeededIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CreateMint2022InitIfNeededIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CreateMint2022InitIfNeededCpiIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CreateMint2022InitIfNeededCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CreateMint2022InitIfNeededCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CreateMint2022InitIfNeededAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_create_mint2022_init_if_needed<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    id: u64,
    mint_bump: u8,
    decimals: u8,
    accounts: CreateMint2022InitIfNeededAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![83, 162, 16, 109, 36, 224, 251, 98];
    let args = CreateMint2022InitIfNeededIxArgs {
        id,
        mint_bump,
        decimals,
    };
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022InitIfNeededCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022InitIfNeededCpiCall<'a> {
    pub accounts: CreateMint2022InitIfNeededCpiAccounts<'a>,
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
...
#[cfg(feature = "cpi")]
pub trait CreateMint2022InitIfNeededCpi<'info> {
    fn create_mint2022_init_if_needed<'a>(
        &self,
        accounts: CreateMint2022InitIfNeededCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
        decimals: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_mint2022_init_if_needed_with_remaining_accounts(CreateMint2022InitIfNeededCpiCall {
        accounts,
        id,
        mint_bump,
        decimals,
    ...
    fn create_mint2022_init_if_needed_signed<'a>(
        &self,
        accounts: CreateMint2022InitIfNeededCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
    ...
    fn create_mint2022_init_if_needed_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022InitIfNeededCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateMint2022InitIfNeededCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn create_mint2022_init_if_needed_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022InitIfNeededCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateMint2022InitIfNeededCpiCall { accounts, id, mint_bump, decimals, signer_seeds, remaining_accounts } = call;
        let args = CreateMint2022InitIfNeededCpiIxArgs {
            id,
            mint_bump,
            decimals,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[83, 162, 16, 109, 36, 224, 251, 98]);
        #[cfg(not(feature = "borsh"))]
        {

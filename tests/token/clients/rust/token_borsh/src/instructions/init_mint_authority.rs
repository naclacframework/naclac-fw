...
pub struct InitMintAuthorityAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_init_mint_authority<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitMintAuthorityAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![110, 95, 157, 123, 154, 140, 42, 253];
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.mint_authority, is_signer: false, is_writable: true }, "mint_authority")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct InitMintAuthorityCpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub mint_authority: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct InitMintAuthorityCpiCall<'a> {
    pub accounts: InitMintAuthorityCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitMintAuthorityCpi<'info> {
    fn init_mint_authority<'a>(
        &self,
        accounts: InitMintAuthorityCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_mint_authority_with_remaining_accounts(InitMintAuthorityCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_mint_authority_signed<'a>(
        &self,
        accounts: InitMintAuthorityCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn init_mint_authority_with_remaining_accounts<'a>(
        &self,
        call: InitMintAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitMintAuthorityCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn init_mint_authority_with_remaining_accounts<'a>(
        &self,
        call: InitMintAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitMintAuthorityCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[110, 95, 157, 123, 154, 140, 42, 253]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.mint_authority.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.mint_authority));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.mint_authority.address(), false),

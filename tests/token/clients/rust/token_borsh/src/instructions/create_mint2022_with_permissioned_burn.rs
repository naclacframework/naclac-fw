...
pub struct CreateMint2022WithPermissionedBurnIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CreateMint2022WithPermissionedBurnIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CreateMint2022WithPermissionedBurnIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CreateMint2022WithPermissionedBurnCpiIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CreateMint2022WithPermissionedBurnCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CreateMint2022WithPermissionedBurnCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CreateMint2022WithPermissionedBurnAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_create_mint2022_with_permissioned_burn<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    id: u64,
    mint_bump: u8,
    decimals: u8,
    accounts: CreateMint2022WithPermissionedBurnAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![141, 126, 93, 19, 247, 89, 233, 108];
    let args = CreateMint2022WithPermissionedBurnIxArgs {
        id,
        mint_bump,
        decimals,
    };
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022WithPermissionedBurnCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022WithPermissionedBurnCpiCall<'a> {
    pub accounts: CreateMint2022WithPermissionedBurnCpiAccounts<'a>,
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
...
#[cfg(feature = "cpi")]
pub trait CreateMint2022WithPermissionedBurnCpi<'info> {
    fn create_mint2022_with_permissioned_burn<'a>(
        &self,
        accounts: CreateMint2022WithPermissionedBurnCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
        decimals: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_mint2022_with_permissioned_burn_with_remaining_accounts(CreateMint2022WithPermissionedBurnCpiCall {
        accounts,
        id,
        mint_bump,
        decimals,
    ...
    fn create_mint2022_with_permissioned_burn_signed<'a>(
        &self,
        accounts: CreateMint2022WithPermissionedBurnCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
    ...
    fn create_mint2022_with_permissioned_burn_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022WithPermissionedBurnCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateMint2022WithPermissionedBurnCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn create_mint2022_with_permissioned_burn_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022WithPermissionedBurnCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateMint2022WithPermissionedBurnCpiCall { accounts, id, mint_bump, decimals, signer_seeds, remaining_accounts } = call;
        let args = CreateMint2022WithPermissionedBurnCpiIxArgs {
            id,
            mint_bump,
            decimals,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[141, 126, 93, 19, 247, 89, 233, 108]);
        #[cfg(not(feature = "borsh"))]
        {

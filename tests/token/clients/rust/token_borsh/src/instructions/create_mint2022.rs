...
pub struct CreateMint2022IxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CreateMint2022IxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CreateMint2022IxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CreateMint2022CpiIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
}
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CreateMint2022CpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CreateMint2022CpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CreateMint2022Accounts {
...
#[cfg(feature = "offchain")]
pub fn build_create_mint2022<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    id: u64,
    mint_bump: u8,
    decimals: u8,
    accounts: CreateMint2022Accounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![188, 181, 9, 68, 12, 33, 187, 18];
    let args = CreateMint2022IxArgs {
        id,
        mint_bump,
        decimals,
    };
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022CpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022CpiCall<'a> {
    pub accounts: CreateMint2022CpiAccounts<'a>,
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
...
#[cfg(feature = "cpi")]
pub trait CreateMint2022Cpi<'info> {
    fn create_mint2022<'a>(
        &self,
        accounts: CreateMint2022CpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
        decimals: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_mint2022_with_remaining_accounts(CreateMint2022CpiCall {
        accounts,
        id,
        mint_bump,
        decimals,
    ...
    fn create_mint2022_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateMint2022Cpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn create_mint2022_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022CpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateMint2022CpiCall { accounts, id, mint_bump, decimals, signer_seeds, remaining_accounts } = call;
        let args = CreateMint2022CpiIxArgs {
            id,
            mint_bump,
            decimals,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[188, 181, 9, 68, 12, 33, 187, 18]);
        #[cfg(not(feature = "borsh"))]
        {

...
pub struct CreateMint2022WithScaledUiAmountIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CreateMint2022WithScaledUiAmountIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CreateMint2022WithScaledUiAmountIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CreateMint2022WithScaledUiAmountCpiIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
    pub multiplier_bits: u64,
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CreateMint2022WithScaledUiAmountCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CreateMint2022WithScaledUiAmountCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CreateMint2022WithScaledUiAmountAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_create_mint2022_with_scaled_ui_amount<'a>(
    ...
    decimals: u8,
    multiplier_bits: u64,
    accounts: CreateMint2022WithScaledUiAmountAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![189, 215, 232, 227, 212, 144, 144, 24];
    let args = CreateMint2022WithScaledUiAmountIxArgs {
        id,
        mint_bump,
        decimals,
        multiplier_bits,
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022WithScaledUiAmountCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct CreateMint2022WithScaledUiAmountCpiCall<'a> {
    pub accounts: CreateMint2022WithScaledUiAmountCpiAccounts<'a>,
    pub id: u64,
    pub mint_bump: u8,
    pub decimals: u8,
    pub multiplier_bits: u64,
...
#[cfg(feature = "cpi")]
pub trait CreateMint2022WithScaledUiAmountCpi<'info> {
    fn create_mint2022_with_scaled_ui_amount<'a>(
        &self,
        accounts: CreateMint2022WithScaledUiAmountCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
        decimals: u8,
        multiplier_bits: u64
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_mint2022_with_scaled_ui_amount_with_remaining_accounts(CreateMint2022WithScaledUiAmountCpiCall {
        accounts,
        id,
        mint_bump,
        decimals,
    ...
    fn create_mint2022_with_scaled_ui_amount_signed<'a>(
        &self,
        accounts: CreateMint2022WithScaledUiAmountCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
    ...
    fn create_mint2022_with_scaled_ui_amount_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022WithScaledUiAmountCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateMint2022WithScaledUiAmountCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenBorsh> {
    fn create_mint2022_with_scaled_ui_amount_with_remaining_accounts<'a>(
        &self,
        call: CreateMint2022WithScaledUiAmountCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateMint2022WithScaledUiAmountCpiCall { accounts, id, mint_bump, decimals, multiplier_bits, signer_seeds, remaining_accounts } = call;
        let args = CreateMint2022WithScaledUiAmountCpiIxArgs {
            id,
            mint_bump,
            decimals,
            multiplier_bits,
        ...
        ix_data.extend_from_slice(&[189, 215, 232, 227, 212, 144, 144, 24]);
        #[cfg(not(feature = "borsh"))]
        {

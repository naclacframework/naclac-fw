...
pub struct CheckAccountFieldsIxArgs {
    pub args: crate::types::CheckAccountFieldsArgs,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CheckAccountFieldsIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CheckAccountFieldsIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CheckAccountFieldsCpiIxArgs {
    pub args: crate::types::CheckAccountFieldsArgsCpi,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CheckAccountFieldsCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CheckAccountFieldsCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CheckAccountFieldsAccounts {
    pub vault: naclac_client::Address,
    pub mint: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_check_account_fields<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    args: crate::types::CheckAccountFieldsArgs,
    accounts: CheckAccountFieldsAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![66, 34, 221, 25, 109, 78, 171, 121];
    let args = CheckAccountFieldsIxArgs {
        args,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct CheckAccountFieldsCpiAccounts<'a> {
    pub vault: crate::sdk_core_cpi::CpiHandle<'a>,
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckAccountFieldsCpiCall<'a> {
    pub accounts: CheckAccountFieldsCpiAccounts<'a>,
    pub args: crate::types::CheckAccountFieldsArgsCpi,
...
#[cfg(feature = "cpi")]
pub trait CheckAccountFieldsCpi<'info> {
    fn check_account_fields<'a>(
        &self,
        accounts: CheckAccountFieldsCpiAccounts<'a>,
        args: crate::types::CheckAccountFieldsArgsCpi
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_account_fields_with_remaining_accounts(CheckAccountFieldsCpiCall {
        accounts,
        args,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn check_account_fields_signed<'a>(
        &self,
        accounts: CheckAccountFieldsCpiAccounts<'a>,
        args: crate::types::CheckAccountFieldsArgsCpi,
        signer_seeds: &[&[&[u8]]]
    ...
    fn check_account_fields_with_remaining_accounts<'a>(
        &self,
        call: CheckAccountFieldsCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckAccountFieldsCpi<'info> for crate::sdk_core_cpi::Program<crate::Token> {
    fn check_account_fields_with_remaining_accounts<'a>(
        &self,
        call: CheckAccountFieldsCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckAccountFieldsCpiCall { accounts, args, signer_seeds, remaining_accounts } = call;
        let args = CheckAccountFieldsCpiIxArgs {
            args,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[66, 34, 221, 25, 109, 78, 171, 121]);
        #[cfg(not(feature = "borsh"))]
        {

...
pub struct CheckNonTransferableIxArgs {
    pub expected_present: u8,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CheckNonTransferableIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CheckNonTransferableIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CheckNonTransferableCpiIxArgs {
    pub expected_present: u8,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CheckNonTransferableCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CheckNonTransferableCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CheckNonTransferableAccounts {
    pub mint: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_check_non_transferable<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    expected_present: u8,
    accounts: CheckNonTransferableAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![109, 115, 191, 131, 114, 38, 137, 144];
    let args = CheckNonTransferableIxArgs {
        expected_present,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub struct CheckNonTransferableCpiAccounts<'a> {
    pub mint: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckNonTransferableCpiCall<'a> {
    pub accounts: CheckNonTransferableCpiAccounts<'a>,
    pub expected_present: u8,
...
#[cfg(feature = "cpi")]
pub trait CheckNonTransferableCpi<'info> {
    fn check_non_transferable<'a>(
        &self,
        accounts: CheckNonTransferableCpiAccounts<'a>,
        expected_present: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_non_transferable_with_remaining_accounts(CheckNonTransferableCpiCall {
        accounts,
        expected_present,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn check_non_transferable_signed<'a>(
        &self,
        accounts: CheckNonTransferableCpiAccounts<'a>,
        expected_present: u8,
        signer_seeds: &[&[&[u8]]]
    ...
    fn check_non_transferable_with_remaining_accounts<'a>(
        &self,
        call: CheckNonTransferableCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckNonTransferableCpi<'info> for crate::sdk_core_cpi::Program<crate::Token> {
    fn check_non_transferable_with_remaining_accounts<'a>(
        &self,
        call: CheckNonTransferableCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckNonTransferableCpiCall { accounts, expected_present, signer_seeds, remaining_accounts } = call;
        let args = CheckNonTransferableCpiIxArgs {
            expected_present,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[109, 115, 191, 131, 114, 38, 137, 144]);
        #[cfg(not(feature = "borsh"))]
        {

...
pub struct InitCounterAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_init_counter<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitCounterAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![247, 168, 146, 45, 125, 26, 142, 80];
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.authority, is_signer: false, is_writable: false }, "authority")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct InitCounterCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitCounterCpiCall<'a> {
    pub accounts: InitCounterCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitCounterCpi<'info> {
    fn init_counter<'a>(
        &self,
        accounts: InitCounterCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_counter_with_remaining_accounts(InitCounterCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_counter_with_remaining_accounts<'a>(
        &self,
        call: InitCounterCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitCounterCpi<'info> for crate::sdk_core_cpi::Program<crate::CpiCallee> {
    fn init_counter_with_remaining_accounts<'a>(
        &self,
        call: InitCounterCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitCounterCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[247, 168, 146, 45, 125, 26, 142, 80]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::readonly(accounts.authority.info.view.address()));
            idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new_readonly(accounts.authority.address(), false),

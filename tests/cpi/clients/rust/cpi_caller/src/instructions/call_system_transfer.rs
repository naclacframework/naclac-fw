...
pub struct CallSystemTransferIxArgs {
    pub amount: u64,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CallSystemTransferIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CallSystemTransferIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CallSystemTransferCpiIxArgs {
    pub amount: u64,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CallSystemTransferCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CallSystemTransferCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CallSystemTransferAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_call_system_transfer<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    amount: u64,
    accounts: CallSystemTransferAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![209, 242, 153, 89, 35, 228, 52, 175];
    let args = CallSystemTransferIxArgs {
        amount,
    };
    #[cfg(not(feature = "borsh"))]
    {
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.caller_authority, is_signer: false, is_writable: true }, "caller_authority")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct CallSystemTransferCpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub caller_authority: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CallSystemTransferCpiCall<'a> {
    pub accounts: CallSystemTransferCpiAccounts<'a>,
    pub amount: u64,
...
#[cfg(feature = "cpi")]
pub trait CallSystemTransferCpi<'info> {
    fn call_system_transfer<'a>(
        &self,
        accounts: CallSystemTransferCpiAccounts<'a>,
        amount: u64
    ) -> crate::sdk_core_cpi::Result<()> {
        self.call_system_transfer_with_remaining_accounts(CallSystemTransferCpiCall {
        accounts,
        amount,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn call_system_transfer_signed<'a>(
        &self,
        accounts: CallSystemTransferCpiAccounts<'a>,
        amount: u64,
        signer_seeds: &[&[&[u8]]]
    ...
    fn call_system_transfer_with_remaining_accounts<'a>(
        &self,
        call: CallSystemTransferCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CallSystemTransferCpi<'info> for crate::sdk_core_cpi::Program<crate::CpiCaller> {
    fn call_system_transfer_with_remaining_accounts<'a>(
        &self,
        call: CallSystemTransferCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CallSystemTransferCpiCall { accounts, amount, signer_seeds, remaining_accounts } = call;
        let args = CallSystemTransferCpiIxArgs {
            amount,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[209, 242, 153, 89, 35, 228, 52, 175]);
        #[cfg(not(feature = "borsh"))]
        {
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.caller_authority.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.caller_authority));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.caller_authority.address(), false),

...
pub struct InitCallerAuthorityAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_init_caller_authority<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitCallerAuthorityAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![19, 43, 92, 16, 194, 225, 143, 217];
...
#[cfg(feature = "cpi")]
pub struct InitCallerAuthorityCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitCallerAuthorityCpiCall<'a> {
    pub accounts: InitCallerAuthorityCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitCallerAuthorityCpi<'info> {
    fn init_caller_authority<'a>(
        &self,
        accounts: InitCallerAuthorityCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_caller_authority_with_remaining_accounts(InitCallerAuthorityCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_caller_authority_signed<'a>(
        &self,
        accounts: InitCallerAuthorityCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn init_caller_authority_with_remaining_accounts<'a>(
        &self,
        call: InitCallerAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitCallerAuthorityCpi<'info> for crate::sdk_core_cpi::Program<crate::CpiCaller> {
    fn init_caller_authority_with_remaining_accounts<'a>(
        &self,
        call: InitCallerAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitCallerAuthorityCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[19, 43, 92, 16, 194, 225, 143, 217]);

...
const IDL = rawIDL as unknown as AccountsConstraintsBorsh;
import * as instructions from "./instructions";
import * as accounts from "./accounts/kit";
import * as types from "./types";

/**
 * High-level client for the `accounts_constraints_borsh` program.
 * Uses the modern @solana/kit (v2) transaction model.
 */
export class AccountsConstraintsBorshClient {

...
pub struct CheckAddressRelationalAccounts {
    ...
    /// deserialized.
    pub expected_address: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_check_address_relational<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: CheckAddressRelationalAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![171, 64, 177, 170, 149, 28, 7, 185];
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.expected_address, is_signer: false, is_writable: false }, "expected_address")
}

#[cfg(feature = "cpi")]
pub struct CheckAddressRelationalCpiAccounts<'a> {
    /// SAFETY: only the account's own address is inspected via the
    /// `address` constraint below; its data is never read or deserialized.
    pub target: crate::sdk_core_cpi::CpiHandle<'a>,
    /// SAFETY: only its own address is read, as the expected value; never
    /// deserialized.
    pub expected_address: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct CheckAddressRelationalCpiCall<'a> {
    pub accounts: CheckAddressRelationalCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait CheckAddressRelationalCpi<'info> {
    fn check_address_relational<'a>(
        &self,
        accounts: CheckAddressRelationalCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_address_relational_with_remaining_accounts(CheckAddressRelationalCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn check_address_relational_signed<'a>(
        &self,
        accounts: CheckAddressRelationalCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn check_address_relational_with_remaining_accounts<'a>(
        &self,
        call: CheckAddressRelationalCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckAddressRelationalCpi<'info> for crate::sdk_core_cpi::Program<crate::AccountsConstraintsBorsh> {
    fn check_address_relational_with_remaining_accounts<'a>(
        &self,
        call: CheckAddressRelationalCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckAddressRelationalCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[171, 64, 177, 170, 149, 28, 7, 185]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::readonly(accounts.expected_address.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(accounts.expected_address);
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new_readonly(accounts.expected_address.address(), false),
            ];
            for (acc, is_writable, is_signer) in remaining_accounts {
                let meta = if *is_writable {

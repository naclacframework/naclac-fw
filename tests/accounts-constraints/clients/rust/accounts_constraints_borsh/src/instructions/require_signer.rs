...
pub fn build_require_signer<'a>(
    ...
    let ix_data = crate::sdk_core::vec![5, 1, 181, 83, 233, 60, 65, 184];
...
pub trait RequireSignerCpi<'info> {
    fn require_signer<'a>(
        ...
        self.require_signer_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn require_signer_signed<'a>(
        ...
        self.require_signer_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> RequireSignerCpi<'info> for crate::sdk_core::Program<crate::AccountsConstraintsBorsh> {
    fn require_signer_with_remaining_accounts<'a>(
        &self,
        accounts: RequireSignerCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],

...
#[cfg_attr(not(feature = "borsh"), derive(Clone, Debug))]
pub struct InitNoteCpiIxArgs {
    pub name: crate::sdk_core_cpi::String,
}

#[cfg(feature = "offchain")]
pub struct InitNoteAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_init_note<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    name: crate::sdk_core_offchain::String,
    accounts: InitNoteAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![210, 21, 99, 159, 132, 44, 76, 125];
    let args = InitNoteIxArgs {
        name,
    };
...
#[cfg(feature = "cpi")]
pub struct InitNoteCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitNoteCpiCall<'a> {
    pub accounts: InitNoteCpiAccounts<'a>,
    pub name: crate::sdk_core_cpi::String,
...
#[cfg(feature = "cpi")]
pub trait InitNoteCpi<'info> {
    fn init_note<'a>(
        &self,
        accounts: InitNoteCpiAccounts<'a>,
        name: crate::sdk_core_cpi::String
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_note_with_remaining_accounts(InitNoteCpiCall {
        accounts,
        name,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn init_note_with_remaining_accounts<'a>(
        &self,
        call: InitNoteCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitNoteCpi<'info> for crate::sdk_core_cpi::Program<crate::AccountsConstraintsBorsh> {
    fn init_note_with_remaining_accounts<'a>(
        &self,
        call: InitNoteCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitNoteCpiCall { accounts, name, signer_seeds, remaining_accounts } = call;
        let args = InitNoteCpiIxArgs {
            name,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[210, 21, 99, 159, 132, 44, 76, 125]);
        #[cfg(not(feature = "borsh"))]
        {
        ix_data.extend_from_slice(&(args.name.len() as u32).to_le_bytes());
        ix_data.extend_from_slice(args.name.as_bytes());

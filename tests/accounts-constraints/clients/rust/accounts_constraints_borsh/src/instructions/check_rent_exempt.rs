...
pub struct CheckRentExemptAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_check_rent_exempt<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: CheckRentExemptAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![218, 238, 171, 16, 41, 107, 170, 172];
...
#[cfg(feature = "cpi")]
pub struct CheckRentExemptCpiAccounts<'a> {
    /// SAFETY: only this account's lamport balance and data length are
    /// inspected via the `rent_exempt` constraint below; its data is never
    /// read or deserialized.
...
#[cfg(feature = "cpi")]
pub struct CheckRentExemptCpiCall<'a> {
    pub accounts: CheckRentExemptCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait CheckRentExemptCpi<'info> {
    fn check_rent_exempt<'a>(
        &self,
        accounts: CheckRentExemptCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.check_rent_exempt_with_remaining_accounts(CheckRentExemptCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn check_rent_exempt_with_remaining_accounts<'a>(
        &self,
        call: CheckRentExemptCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CheckRentExemptCpi<'info> for crate::sdk_core_cpi::Program<crate::AccountsConstraintsBorsh> {
    fn check_rent_exempt_with_remaining_accounts<'a>(
        &self,
        call: CheckRentExemptCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CheckRentExemptCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[218, 238, 171, 16, 41, 107, 170, 172]);

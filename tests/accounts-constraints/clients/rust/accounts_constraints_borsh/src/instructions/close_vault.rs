...
pub fn build_close_vault<'a>(
    ...
    let ix_data = crate::sdk_core_offchain::vec![141, 103, 17, 126, 72, 75, 29, 29];
...
#[cfg(feature = "cpi")]
pub struct CloseVaultCpiCall<'a> {
    pub accounts: CloseVaultCpiAccounts<'a>,
...
pub trait CloseVaultCpi<'info> {
    fn close_vault<'a>(
        ...
        self.close_vault_with_remaining_accounts(CloseVaultCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn close_vault_with_remaining_accounts<'a>(
        &self,
        call: CloseVaultCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CloseVaultCpi<'info> for crate::sdk_core_cpi::Program<crate::AccountsConstraintsBorsh> {
    fn close_vault_with_remaining_accounts<'a>(
        &self,
        call: CloseVaultCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CloseVaultCpiCall { accounts, signer_seeds, remaining_accounts } = call;

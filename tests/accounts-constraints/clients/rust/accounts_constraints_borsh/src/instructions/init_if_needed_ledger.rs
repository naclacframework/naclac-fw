...
unsafe impl crate::sdk_core::bytemuck::Zeroable for InitIfNeededLedgerIxArgs {}
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core::bytemuck::Pod for InitIfNeededLedgerIxArgs {}
...
pub fn build_init_if_needed_ledger<'a>(
    ...
    let mut ix_data = crate::sdk_core::vec![22, 82, 120, 44, 13, 132, 41, 18];
...
pub struct InitIfNeededLedgerCpiAccounts<'a> {
    ...
    pub ledger: crate::sdk_core::CpiHandleMut<'a>,
...
pub trait InitIfNeededLedgerCpi<'info> {
    fn init_if_needed_ledger<'a>(
        ...
        self.init_if_needed_ledger_with_remaining_accounts(accounts, value, &[], &[])
    }
    ...
    fn init_if_needed_ledger_signed<'a>(
        ...
        self.init_if_needed_ledger_with_remaining_accounts(accounts, value, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> InitIfNeededLedgerCpi<'info> for crate::sdk_core::Program<crate::AccountsConstraintsBorsh> {
    fn init_if_needed_ledger_with_remaining_accounts<'a>(
        &self,
        accounts: InitIfNeededLedgerCpiAccounts<'a>,
        value: u64,
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core::pinocchio::instruction::InstructionAccount::writable(accounts.ledger.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core::CpiHandle::from(accounts.ledger));
            h_idx += 1;

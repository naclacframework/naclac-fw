...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for TouchSeededIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for TouchSeededIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct TouchSeededCpiIxArgs {
    pub bump: u8,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for TouchSeededCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for TouchSeededCpiIxArgs {}
...
pub fn build_touch_seeded<'a>(
    ...
    let mut ix_data = crate::sdk_core_offchain::vec![113, 221, 0, 65, 190, 116, 9, 205];
...
#[cfg(feature = "cpi")]
pub struct TouchSeededCpiCall<'a> {
    pub accounts: TouchSeededCpiAccounts<'a>,
    pub bump: u8,
...
pub trait TouchSeededCpi<'info> {
    fn touch_seeded<'a>(
        ...
        self.touch_seeded_with_remaining_accounts(TouchSeededCpiCall {
        accounts,
        bump,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn touch_seeded_with_remaining_accounts<'a>(
        &self,
        call: TouchSeededCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> TouchSeededCpi<'info> for crate::sdk_core_cpi::Program<crate::AccountsConstraintsBorsh> {
    fn touch_seeded_with_remaining_accounts<'a>(
        &self,
        call: TouchSeededCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let TouchSeededCpiCall { accounts, bump, signer_seeds, remaining_accounts } = call;
        let args = TouchSeededCpiIxArgs {
            bump,
        };

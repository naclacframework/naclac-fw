...
pub fn build_init_vault<'a>(
    ...
    let ix_data = crate::sdk_core_offchain::vec![77, 79, 85, 150, 33, 217, 52, 106];
...
#[cfg(feature = "cpi")]
pub struct InitVaultCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitVaultCpiCall<'a> {
    pub accounts: InitVaultCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitVaultCpi<'info> {
    fn init_vault<'a>(
        &self,
        accounts: InitVaultCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_vault_with_remaining_accounts(InitVaultCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_vault_with_remaining_accounts<'a>(
        &self,
        call: InitVaultCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitVaultCpi<'info> for crate::sdk_core_cpi::Program<crate::AccountsConstraintsBorsh> {
    fn init_vault_with_remaining_accounts<'a>(
        &self,
        call: InitVaultCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitVaultCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[77, 79, 85, 150, 33, 217, 52, 106]);

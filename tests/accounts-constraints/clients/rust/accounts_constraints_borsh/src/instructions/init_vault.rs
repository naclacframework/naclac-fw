...
pub fn build_init_vault<'a>(
    ...
    let ix_data = crate::sdk_core::vec![77, 79, 85, 150, 33, 217, 52, 106];
...
pub trait InitVaultCpi<'info> {
    fn init_vault<'a>(
        ...
        self.init_vault_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn init_vault_signed<'a>(
        ...
        self.init_vault_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> InitVaultCpi<'info> for crate::sdk_core::Program<crate::AccountsConstraintsBorsh> {
    fn init_vault_with_remaining_accounts<'a>(
        &self,
        accounts: InitVaultCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],

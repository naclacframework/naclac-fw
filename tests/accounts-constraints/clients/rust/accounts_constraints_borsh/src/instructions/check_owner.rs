...
pub fn build_check_owner<'a>(
    ...
    let ix_data = crate::sdk_core::vec![215, 161, 49, 182, 161, 8, 67, 193];
...
pub trait CheckOwnerCpi<'info> {
    fn check_owner<'a>(
        ...
        self.check_owner_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn check_owner_signed<'a>(
        ...
        self.check_owner_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> CheckOwnerCpi<'info> for crate::sdk_core::Program<crate::AccountsConstraintsBorsh> {
    fn check_owner_with_remaining_accounts<'a>(
        &self,
        accounts: CheckOwnerCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],

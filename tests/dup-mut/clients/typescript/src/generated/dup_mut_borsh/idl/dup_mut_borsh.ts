export const IDL = {
  "address": "3B6MfxvFZKbQeUANMazZZ2og8vg9VReJecNjE8XfMvFv",
  "metadata": {
    "name": "dup_mut_borsh",
    "version": "0.1.0",
    "description": "dup_mut_borsh — Generated by Naclac Framework"
  },
  "instructions": [
    {
      "name": "init_vault_a",
    ...
    {
      "name": "touch_boxed_vault",
      "optionalAccountStrategy": "programId",
      "discriminator": [136,73,198,15,185,22,147,122],
      "accounts": [
...
export type DupMutBorsh = typeof IDL;

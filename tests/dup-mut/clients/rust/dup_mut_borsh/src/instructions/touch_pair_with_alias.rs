...
pub struct TouchPairWithAliasAccounts {
    pub a: naclac_client::Address,
    pub b: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_touch_pair_with_alias<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: TouchPairWithAliasAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![219, 171, 202, 60, 127, 192, 17, 249];
...
#[cfg(feature = "cpi")]
pub struct TouchPairWithAliasCpiAccounts<'a> {
    pub a: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub b: crate::sdk_core_cpi::CpiHandleMut<'a>,
}

#[cfg(feature = "cpi")]
pub struct TouchPairWithAliasCpiCall<'a> {
    pub accounts: TouchPairWithAliasCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait TouchPairWithAliasCpi<'info> {
    fn touch_pair_with_alias<'a>(
        &self,
        accounts: TouchPairWithAliasCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.touch_pair_with_alias_with_remaining_accounts(TouchPairWithAliasCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn touch_pair_with_alias_signed<'a>(
        &self,
        accounts: TouchPairWithAliasCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn touch_pair_with_alias_with_remaining_accounts<'a>(
        &self,
        call: TouchPairWithAliasCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> TouchPairWithAliasCpi<'info> for crate::sdk_core_cpi::Program<crate::DupMutBorsh> {
    fn touch_pair_with_alias_with_remaining_accounts<'a>(
        &self,
        call: TouchPairWithAliasCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let TouchPairWithAliasCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[219, 171, 202, 60, 127, 192, 17, 249]);

...
pub fn build_touch_pair_with_alias<'a>(
    ...
    let ix_data = crate::sdk_core::vec![219, 171, 202, 60, 127, 192, 17, 249];
...
pub trait TouchPairWithAliasCpi<'info> {
    fn touch_pair_with_alias<'a>(
        ...
        self.touch_pair_with_alias_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn touch_pair_with_alias_signed<'a>(
        ...
        self.touch_pair_with_alias_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> TouchPairWithAliasCpi<'info> for crate::sdk_core::Program<crate::DupMutBorsh> {
    fn touch_pair_with_alias_with_remaining_accounts<'a>(
        &self,
        accounts: TouchPairWithAliasCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],

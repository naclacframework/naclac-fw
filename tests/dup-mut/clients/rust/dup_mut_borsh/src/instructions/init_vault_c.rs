...
pub struct InitVaultCAccounts {
    pub payer: naclac_client::Address,
    pub vault_c: naclac_client::Address,
    pub system_program: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_init_vault_c<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitVaultCAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![121, 83, 62, 0, 42, 66, 213, 40];
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.vault_c, is_signer: false, is_writable: true }, "vault_c")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct InitVaultCCpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub vault_c: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct InitVaultCCpiCall<'a> {
    pub accounts: InitVaultCCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitVaultCCpi<'info> {
    fn init_vault_c<'a>(
        &self,
        accounts: InitVaultCCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_vault_c_with_remaining_accounts(InitVaultCCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_vault_c_with_remaining_accounts<'a>(
        &self,
        call: InitVaultCCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitVaultCCpi<'info> for crate::sdk_core_cpi::Program<crate::DupMutBorsh> {
    fn init_vault_c_with_remaining_accounts<'a>(
        &self,
        call: InitVaultCCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitVaultCCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[121, 83, 62, 0, 42, 66, 213, 40]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.vault_c.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.vault_c));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.vault_c.address(), false),

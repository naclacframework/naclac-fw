...
pub fn build_init_vault_b<'a>(
    ...
    let ix_data = crate::sdk_core_offchain::vec![148, 188, 44, 18, 76, 170, 255, 111];
...
#[cfg(feature = "cpi")]
pub struct InitVaultBCpiCall<'a> {
    pub accounts: InitVaultBCpiAccounts<'a>,
...
pub trait InitVaultBCpi<'info> {
    fn init_vault_b<'a>(
        ...
        self.init_vault_b_with_remaining_accounts(InitVaultBCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_vault_b_with_remaining_accounts<'a>(
        &self,
        call: InitVaultBCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitVaultBCpi<'info> for crate::sdk_core_cpi::Program<crate::DupMutBorsh> {
    fn init_vault_b_with_remaining_accounts<'a>(
        &self,
        call: InitVaultBCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitVaultBCpiCall { accounts, signer_seeds, remaining_accounts } = call;

...
pub struct TouchBoxedVaultAccounts {
    pub target: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_touch_boxed_vault<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: TouchBoxedVaultAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![136, 73, 198, 15, 185, 22, 147, 122];
...
#[cfg(feature = "cpi")]
pub struct TouchBoxedVaultCpiAccounts<'a> {
    pub target: crate::sdk_core_cpi::CpiHandleMut<'a>,
}

#[cfg(feature = "cpi")]
pub struct TouchBoxedVaultCpiCall<'a> {
    pub accounts: TouchBoxedVaultCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait TouchBoxedVaultCpi<'info> {
    fn touch_boxed_vault<'a>(
        &self,
        accounts: TouchBoxedVaultCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.touch_boxed_vault_with_remaining_accounts(TouchBoxedVaultCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn touch_boxed_vault_with_remaining_accounts<'a>(
        &self,
        call: TouchBoxedVaultCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> TouchBoxedVaultCpi<'info> for crate::sdk_core_cpi::Program<crate::DupMutBorsh> {
    fn touch_boxed_vault_with_remaining_accounts<'a>(
        &self,
        call: TouchBoxedVaultCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let TouchBoxedVaultCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[136, 73, 198, 15, 185, 22, 147, 122]);

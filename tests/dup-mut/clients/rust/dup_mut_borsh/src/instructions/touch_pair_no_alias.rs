...
pub fn build_touch_pair_no_alias<'a>(
    ...
    let ix_data = crate::sdk_core_offchain::vec![190, 215, 73, 163, 169, 6, 238, 225];
...
#[cfg(feature = "cpi")]
pub struct TouchPairNoAliasCpiCall<'a> {
    pub accounts: TouchPairNoAliasCpiAccounts<'a>,
...
pub trait TouchPairNoAliasCpi<'info> {
    fn touch_pair_no_alias<'a>(
        ...
        self.touch_pair_no_alias_with_remaining_accounts(TouchPairNoAliasCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn touch_pair_no_alias_with_remaining_accounts<'a>(
        &self,
        call: TouchPairNoAliasCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> TouchPairNoAliasCpi<'info> for crate::sdk_core_cpi::Program<crate::DupMutBorsh> {
    fn touch_pair_no_alias_with_remaining_accounts<'a>(
        &self,
        call: TouchPairNoAliasCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let TouchPairNoAliasCpiCall { accounts, signer_seeds, remaining_accounts } = call;

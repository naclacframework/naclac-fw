...
pub fn build_init_vault_a<'a>(
    ...
    let ix_data = crate::sdk_core::vec![143, 170, 60, 61, 53, 112, 187, 2];
...
pub trait InitVaultACpi<'info> {
    fn init_vault_a<'a>(
        ...
        self.init_vault_a_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn init_vault_a_signed<'a>(
        ...
        self.init_vault_a_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> InitVaultACpi<'info> for crate::sdk_core::Program<crate::DupMutBorsh> {
    fn init_vault_a_with_remaining_accounts<'a>(
        &self,
        accounts: InitVaultACpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],

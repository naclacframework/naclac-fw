...
#[cfg(feature = "offchain")]
pub fn build_init_vault_a<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitVaultAAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![143, 170, 60, 61, 53, 112, 187, 2];
...
#[cfg(feature = "cpi")]
pub struct InitVaultACpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitVaultACpiCall<'a> {
    pub accounts: InitVaultACpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitVaultACpi<'info> {
    fn init_vault_a<'a>(
        &self,
        accounts: InitVaultACpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_vault_a_with_remaining_accounts(InitVaultACpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_vault_a_with_remaining_accounts<'a>(
        &self,
        call: InitVaultACpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitVaultACpi<'info> for crate::sdk_core_cpi::Program<crate::DupMutBorsh> {
    fn init_vault_a_with_remaining_accounts<'a>(
        &self,
        call: InitVaultACpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitVaultACpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[143, 170, 60, 61, 53, 112, 187, 2]);

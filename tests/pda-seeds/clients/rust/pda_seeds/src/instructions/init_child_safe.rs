...
pub fn build_init_child_safe<'a>(
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.child_safe, is_signer: false, is_writable: true }, "child_safe")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct InitChildSafeCpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub registry: crate::sdk_core_cpi::CpiHandle<'a>,
    pub child_safe: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct InitChildSafeCpiCall<'a> {
    pub accounts: InitChildSafeCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitChildSafeCpi<'info> {
    fn init_child_safe<'a>(
        &self,
        accounts: InitChildSafeCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_child_safe_with_remaining_accounts(InitChildSafeCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_child_safe_with_remaining_accounts<'a>(
        &self,
        call: InitChildSafeCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitChildSafeCpi<'info> for crate::sdk_core_cpi::Program<crate::PdaSeeds> {
    fn init_child_safe_with_remaining_accounts<'a>(
        &self,
        call: InitChildSafeCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitChildSafeCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[28, 228, 30, 126, 154, 251, 158, 96]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.child_safe.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.child_safe));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.child_safe.address(), false),

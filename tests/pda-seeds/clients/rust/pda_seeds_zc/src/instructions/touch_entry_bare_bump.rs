...
pub fn build_touch_entry_bare_bump<'a>(
    ...
    let ix_data = crate::sdk_core::vec![80, 160, 133, 100, 61, 110, 159, 113];
...
pub trait TouchEntryBareBumpCpi<'info> {
    fn touch_entry_bare_bump<'a>(
        ...
        self.touch_entry_bare_bump_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn touch_entry_bare_bump_signed<'a>(
        ...
        self.touch_entry_bare_bump_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> TouchEntryBareBumpCpi<'info> for crate::sdk_core::Program<crate::PdaSeedsZc> {
    fn touch_entry_bare_bump_with_remaining_accounts<'a>(
        &self,
        accounts: TouchEntryBareBumpCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],

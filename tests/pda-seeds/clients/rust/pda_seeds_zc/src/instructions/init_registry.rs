...
pub fn build_init_registry<'a>(
    ...
    let ix_data = crate::sdk_core::vec![131, 22, 4, 103, 24, 94, 163, 239];
...
pub trait InitRegistryCpi<'info> {
    fn init_registry<'a>(
        ...
        self.init_registry_with_remaining_accounts(accounts, &[], &[])
    }
    ...
    fn init_registry_signed<'a>(
        ...
        self.init_registry_with_remaining_accounts(accounts, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> InitRegistryCpi<'info> for crate::sdk_core::Program<crate::PdaSeedsZc> {
    fn init_registry_with_remaining_accounts<'a>(
        &self,
        accounts: InitRegistryCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]],

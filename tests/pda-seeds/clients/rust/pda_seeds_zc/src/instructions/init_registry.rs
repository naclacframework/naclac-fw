...
pub struct InitRegistryAccounts {
...
#[cfg(feature = "offchain")]
pub fn build_init_registry<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitRegistryAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![131, 22, 4, 103, 24, 94, 163, 239];
...
#[cfg(feature = "cpi")]
pub struct InitRegistryCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitRegistryCpiCall<'a> {
    pub accounts: InitRegistryCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitRegistryCpi<'info> {
    fn init_registry<'a>(
        &self,
        accounts: InitRegistryCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_registry_with_remaining_accounts(InitRegistryCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_registry_with_remaining_accounts<'a>(
        &self,
        call: InitRegistryCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitRegistryCpi<'info> for crate::sdk_core_cpi::Program<crate::PdaSeedsZc> {
    fn init_registry_with_remaining_accounts<'a>(
        &self,
        call: InitRegistryCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitRegistryCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[131, 22, 4, 103, 24, 94, 163, 239]);

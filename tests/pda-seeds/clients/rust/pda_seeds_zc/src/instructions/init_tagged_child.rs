...
unsafe impl crate::sdk_core::bytemuck::Zeroable for InitTaggedChildIxArgs {}
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core::bytemuck::Pod for InitTaggedChildIxArgs {}
...
pub fn build_init_tagged_child<'a>(
    ...
    let mut ix_data = crate::sdk_core::vec![40, 46, 85, 175, 69, 80, 143, 191];
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.tagged_child, is_signer: false, is_writable: true }, "taggedChild")
...
pub struct InitTaggedChildCpiAccounts<'a> {
    ...
    pub tagged_child: crate::sdk_core::CpiHandleMut<'a>,
...
pub trait InitTaggedChildCpi<'info> {
    fn init_tagged_child<'a>(
        ...
        self.init_tagged_child_with_remaining_accounts(accounts, bump, &[], &[])
    }
    ...
    fn init_tagged_child_signed<'a>(
        ...
        self.init_tagged_child_with_remaining_accounts(accounts, bump, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> InitTaggedChildCpi<'info> for crate::sdk_core::Program<crate::PdaSeedsZc> {
    fn init_tagged_child_with_remaining_accounts<'a>(
        &self,
        accounts: InitTaggedChildCpiAccounts<'a>,
        bump: u8,
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core::pinocchio::instruction::InstructionAccount::writable(accounts.tagged_child.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core::CpiHandle::from(accounts.tagged_child));
            h_idx += 1;

...
pub struct InitChildIxArgs {
    pub bump: u8,
}

#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for InitChildIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for InitChildIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct InitChildCpiIxArgs {
    pub bump: u8,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for InitChildCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for InitChildCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct InitChildAccounts {
    pub payer: naclac_client::Address,
    pub registry: naclac_client::Address,
    pub child: naclac_client::Address,
    pub system_program: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_init_child<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    bump: u8,
    accounts: InitChildAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let mut ix_data = crate::sdk_core_offchain::vec![132, 124, 156, 240, 193, 211, 5, 207];
    let args = InitChildIxArgs {
        bump,
    };
    #[cfg(not(feature = "borsh"))]
    {
...
#[cfg(feature = "cpi")]
pub trait InitChildCpi<'info> {
    fn init_child<'a>(
        &self,
        accounts: InitChildCpiAccounts<'a>,
        bump: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_child_with_remaining_accounts(InitChildCpiCall {
        accounts,
        bump,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn init_child_with_remaining_accounts<'a>(
        &self,
        call: InitChildCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitChildCpi<'info> for crate::sdk_core_cpi::Program<crate::PdaSeedsZc> {
    fn init_child_with_remaining_accounts<'a>(
        &self,
        call: InitChildCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitChildCpiCall { accounts, bump, signer_seeds, remaining_accounts } = call;
        let args = InitChildCpiIxArgs {
            bump,
        };
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[132, 124, 156, 240, 193, 211, 5, 207]);
        #[cfg(not(feature = "borsh"))]
        {
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.child.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.child));
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new(accounts.child.address(), false),

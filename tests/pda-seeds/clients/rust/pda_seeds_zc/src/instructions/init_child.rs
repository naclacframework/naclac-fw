...
unsafe impl crate::sdk_core::bytemuck::Zeroable for InitChildIxArgs {}
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core::bytemuck::Pod for InitChildIxArgs {}
...
pub fn build_init_child<'a>(
    ...
    let mut ix_data = crate::sdk_core::vec![132, 124, 156, 240, 193, 211, 5, 207];
...
pub struct InitChildCpiAccounts<'a> {
    ...
    pub child: crate::sdk_core::CpiHandleMut<'a>,
...
pub trait InitChildCpi<'info> {
    fn init_child<'a>(
        ...
        self.init_child_with_remaining_accounts(accounts, bump, &[], &[])
    }
    ...
    fn init_child_signed<'a>(
        ...
        self.init_child_with_remaining_accounts(accounts, bump, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> InitChildCpi<'info> for crate::sdk_core::Program<crate::PdaSeedsZc> {
    fn init_child_with_remaining_accounts<'a>(
        &self,
        accounts: InitChildCpiAccounts<'a>,
        bump: u8,
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core::pinocchio::instruction::InstructionAccount::writable(accounts.child.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core::CpiHandle::from(accounts.child));
            h_idx += 1;

...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for InitEntryIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for InitEntryIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct InitEntryCpiIxArgs {
    pub bump: u8,
}

#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for InitEntryCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for InitEntryCpiIxArgs {}
...
pub fn build_init_entry<'a>(
    ...
    let mut ix_data = crate::sdk_core_offchain::vec![207, 80, 17, 185, 229, 148, 170, 183];
...
pub struct InitEntryCpiAccounts<'a> {
    ...
    pub entry: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct InitEntryCpiCall<'a> {
    pub accounts: InitEntryCpiAccounts<'a>,
    pub bump: u8,
...
pub trait InitEntryCpi<'info> {
    fn init_entry<'a>(
        ...
        self.init_entry_with_remaining_accounts(InitEntryCpiCall {
        accounts,
        bump,
        signer_seeds: &[],
        remaining_accounts: &[],
    ...
    fn init_entry_with_remaining_accounts<'a>(
        &self,
        call: InitEntryCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitEntryCpi<'info> for crate::sdk_core_cpi::Program<crate::PdaSeedsZc> {
    fn init_entry_with_remaining_accounts<'a>(
        &self,
        call: InitEntryCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitEntryCpiCall { accounts, bump, signer_seeds, remaining_accounts } = call;
        let args = InitEntryCpiIxArgs {
            bump,
        };
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::writable(accounts.entry.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(crate::sdk_core_cpi::CpiHandle::from(accounts.entry));
            h_idx += 1;

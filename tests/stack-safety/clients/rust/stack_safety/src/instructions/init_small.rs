...
#[cfg(feature = "offchain")]
pub fn build_init_small<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitSmallAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![83, 231, 209, 225, 237, 234, 83, 100];
...
#[cfg(feature = "cpi")]
pub struct InitSmallCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitSmallCpiCall<'a> {
    pub accounts: InitSmallCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitSmallCpi<'info> {
    fn init_small<'a>(
        &self,
        accounts: InitSmallCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_small_with_remaining_accounts(InitSmallCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_small_with_remaining_accounts<'a>(
        &self,
        call: InitSmallCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitSmallCpi<'info> for crate::sdk_core_cpi::Program<crate::StackSafety> {
    fn init_small_with_remaining_accounts<'a>(
        &self,
        call: InitSmallCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitSmallCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[83, 231, 209, 225, 237, 234, 83, 100]);

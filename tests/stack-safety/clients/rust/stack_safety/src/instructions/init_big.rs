...
#[cfg(feature = "offchain")]
pub fn build_init_big<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: InitBigAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![104, 177, 111, 3, 102, 2, 149, 34];
...
#[cfg(feature = "cpi")]
pub struct InitBigCpiAccounts<'a> {
...
#[cfg(feature = "cpi")]
pub struct InitBigCpiCall<'a> {
    pub accounts: InitBigCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait InitBigCpi<'info> {
    fn init_big<'a>(
        &self,
        accounts: InitBigCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.init_big_with_remaining_accounts(InitBigCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn init_big_with_remaining_accounts<'a>(
        &self,
        call: InitBigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> InitBigCpi<'info> for crate::sdk_core_cpi::Program<crate::StackSafety> {
    fn init_big_with_remaining_accounts<'a>(
        &self,
        call: InitBigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let InitBigCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[104, 177, 111, 3, 102, 2, 149, 34]);

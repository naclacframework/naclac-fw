...
#[cfg(feature = "cpi")]
pub struct CloseBigCpiAccounts<'a> {
    pub payer: crate::sdk_core_cpi::CpiHandleMut<'a>,
    pub big: crate::sdk_core_cpi::CpiHandleMut<'a>,
}

#[cfg(feature = "cpi")]
pub struct CloseBigCpiCall<'a> {
    pub accounts: CloseBigCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait CloseBigCpi<'info> {
    fn close_big<'a>(
        &self,
        accounts: CloseBigCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.close_big_with_remaining_accounts(CloseBigCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn close_big_with_remaining_accounts<'a>(
        &self,
        call: CloseBigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CloseBigCpi<'info> for crate::sdk_core_cpi::Program<crate::StackSafety> {
    fn close_big_with_remaining_accounts<'a>(
        &self,
        call: CloseBigCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CloseBigCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[80, 248, 96, 7, 7, 207, 31, 221]);

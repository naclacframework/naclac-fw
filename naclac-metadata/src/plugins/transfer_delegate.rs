...
pub fn attach_transfer_delegate_signed(
    ...
    {
        let data = [2u8, plugin_type::TRANSFER_DELEGATE, 0u8];
    ...
    #[cfg(feature = "pinocchio")]
    {
        ...
        data.push(plugin_type::TRANSFER_DELEGATE);
...
pub fn asset_has_transfer_delegate(info: &AccountInfo) -> Result<bool> {
    ...
    Ok(find_plugin_offset(&data, plugin_header_offset, plugin_type::TRANSFER_DELEGATE)?.is_some())
}

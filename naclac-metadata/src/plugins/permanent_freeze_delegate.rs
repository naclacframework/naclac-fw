...
pub fn attach_permanent_freeze_delegate_signed(
    ...
    {
        let data = [2u8, plugin_type::PERMANENT_FREEZE_DELEGATE, frozen as u8, 0u8];
    ...
    #[cfg(feature = "pinocchio")]
    {
        ...
        data.push(plugin_type::PERMANENT_FREEZE_DELEGATE);
...
pub fn attach_collection_permanent_freeze_delegate_signed(
    ...
    #[cfg(not(feature = "pinocchio"))]
    {
        let data = [3u8, plugin_type::PERMANENT_FREEZE_DELEGATE, frozen as u8, 0u8];
...
pub fn fetch_asset_permanent_freeze_delegate(info: &AccountInfo) -> Result<Option<bool>> {
    ...
    read_permanent_freeze_delegate(&data, plugin_header_offset)
}
...
/// `fetch_collection_permanent_freeze_delegate`, shared by both backends:

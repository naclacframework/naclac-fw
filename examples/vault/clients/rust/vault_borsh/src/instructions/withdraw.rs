...
pub trait WithdrawCpi<'info> {
    fn withdraw<'a>(
        ...
        self.withdraw_with_remaining_accounts(accounts, amount, &[], &[])
    }
    ...
    fn withdraw_signed<'a>(
        ...
        self.withdraw_with_remaining_accounts(accounts, amount, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> WithdrawCpi<'info> for crate::sdk_core::Program<crate::VaultBorsh> {
    fn withdraw_with_remaining_accounts<'a>(
        &self,
        accounts: WithdrawCpiAccounts<'a>,
        amount: u64,

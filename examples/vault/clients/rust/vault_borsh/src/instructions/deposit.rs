...
pub trait DepositCpi<'info> {
    fn deposit<'a>(
        ...
        self.deposit_with_remaining_accounts(accounts, amount, user_bump, &[], &[])
    }
    ...
    fn deposit_signed<'a>(
        ...
        self.deposit_with_remaining_accounts(accounts, amount, user_bump, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> DepositCpi<'info> for crate::sdk_core::Program<crate::VaultBorsh> {
    fn deposit_with_remaining_accounts<'a>(
        &self,
        accounts: DepositCpiAccounts<'a>,
        amount: u64,

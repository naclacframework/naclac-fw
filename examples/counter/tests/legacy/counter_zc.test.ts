...
import { CounterZcClient } from "../../clients/typescript/src/generated/counter_zc/client-legacy";

describe("Naclac CounterZc Test Suite (Legacy)", () => {
  let client: CounterZcClient;

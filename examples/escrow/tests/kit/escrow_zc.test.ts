...
import { EscrowZcClient } from "../../clients/typescript/src/generated/escrow_zc";

describe("Naclac EscrowZc Test Suite", () => {
  ...
  before(async () => {
    ...
    console.log("🚀 Starting EscrowZc TypeScript Integration Test Setup...");

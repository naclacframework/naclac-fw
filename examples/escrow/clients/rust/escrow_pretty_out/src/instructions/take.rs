...
pub struct TakeIxArgs {
    pub seed: u64,
}
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core::bytemuck::Zeroable for TakeIxArgs {}
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core::bytemuck::Pod for TakeIxArgs {}
#[cfg(feature = "offchain")]
pub struct TakeAccounts {
    pub taker: naclac_client::Address,
    ...
    pub taker_token_account_a: naclac_client::Address,
    pub taker_token_account_b: naclac_client::Address,
    pub maker_token_account_b: naclac_client::Address,
...
pub fn build_take<'a>(
    ...
    let mut ix_data = crate::sdk_core::vec![149, 226, 52, 104, 6, 142, 230, 39];
    let args = TakeIxArgs { seed };
    #[cfg(not(feature = "borsh"))]
    {
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(
            naclac_client::AccountMeta {
                address: accounts.taker_token_account_a,
                is_signer: false,
                is_writable: true,
            },
            "takerTokenAccountA",
        ...
        .account(
            naclac_client::AccountMeta {
                address: accounts.taker_token_account_b,
                is_signer: false,
                is_writable: true,
            },
            "takerTokenAccountB",
        ...
        .account(
            naclac_client::AccountMeta {
                address: accounts.maker_token_account_b,
                is_signer: false,
                is_writable: true,
            },
            "makerTokenAccountB",
...
pub struct TakeCpiAccounts {
    pub taker: crate::sdk_core::AccountInfo,
    ...
    pub taker_token_account_a: crate::sdk_core::AccountInfo,
    pub taker_token_account_b: crate::sdk_core::AccountInfo,
    pub maker_token_account_b: crate::sdk_core::AccountInfo,
    pub token_program: crate::sdk_core::AccountInfo,
    pub system_program: crate::sdk_core::AccountInfo,
}
#[cfg(feature = "cpi")]
#[derive(Clone)]
pub struct TakeCpiBuilder<'a> {
    pub program_id: &'a crate::sdk_core::Address,
    pub args: TakeIxArgs,
    pub accounts: TakeCpiAccounts,
    pub remaining_accounts: crate::sdk_core::Vec<
        (crate::sdk_core::AccountInfo, bool, bool),
    >,
}
#[cfg(feature = "cpi")]
impl<'a> TakeCpiBuilder<'a> {
    pub fn new(
        program_id: &'a crate::sdk_core::Address,
        accounts: TakeCpiAccounts,
        seed: u64,
    ) -> Self {
        Self {
            program_id,
            args: TakeIxArgs { seed },
            accounts,
    ...
    pub fn invoke_signed(
        ...
        ix_data.extend_from_slice(&[149, 226, 52, 104, 6, 142, 230, 39]);
        #[cfg(not(feature = "borsh"))]
        {
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            account_metas
                .push(
                    crate::sdk_core::pinocchio::instruction::InstructionAccount::writable_signer(
                        self.accounts.taker.view.address(),
                    ),
                );
            account_infos.push(self.accounts.taker.view);
            account_metas
                .push(
            ...
            account_metas
                .push(
                    crate::sdk_core::pinocchio::instruction::InstructionAccount::writable(
                        self.accounts.taker_token_account_a.view.address(),
                    ),
                );
            account_infos.push(self.accounts.taker_token_account_a.view);
            account_metas
                .push(
                    crate::sdk_core::pinocchio::instruction::InstructionAccount::writable(
                        self.accounts.taker_token_account_b.view.address(),
                    ),
                );
            account_infos.push(self.accounts.taker_token_account_b.view);
            account_metas
                .push(
                    crate::sdk_core::pinocchio::instruction::InstructionAccount::writable(
                        self.accounts.maker_token_account_b.view.address(),
                    ),
                );
            account_infos.push(self.accounts.maker_token_account_b.view);
            account_metas
                .push(
                    crate::sdk_core::pinocchio::instruction::InstructionAccount::readonly(
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            account_infos.push(self.accounts.taker.clone());
            account_metas
                .push(
                    ::naclac_lang::solana_program::instruction::AccountMeta::new(
            ...
            account_metas
                .push(
                    ::naclac_lang::solana_program::instruction::AccountMeta::new(
                        *self.accounts.taker_token_account_a.key,
                        false,
                    ),
                );
            account_infos.push(self.accounts.taker_token_account_a.clone());
            account_metas
                .push(
                    ::naclac_lang::solana_program::instruction::AccountMeta::new(
                        *self.accounts.taker_token_account_b.key,
                        false,
                    ),
                );
            account_infos.push(self.accounts.taker_token_account_b.clone());
            account_metas
                .push(
                    ::naclac_lang::solana_program::instruction::AccountMeta::new(
                        *self.accounts.maker_token_account_b.key,
                        false,
                    ),
                );
            account_infos.push(self.accounts.maker_token_account_b.clone());
            account_metas
                .push(
                    ::naclac_lang::solana_program::instruction::AccountMeta::new_readonly(

...
unsafe impl crate::sdk_core_offchain::bytemuck::Zeroable for CreateMintIxArgs {}
#[cfg(feature = "offchain")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_offchain::bytemuck::Pod for CreateMintIxArgs {}
...
#[cfg_attr(not(feature = "borsh"), derive(Copy, Clone, Debug))]
#[cfg_attr(not(feature = "borsh"), repr(C, packed))]
pub struct CreateMintCpiIxArgs {
    pub id: u64,
    pub mint_bump: u8,
    pub launch_record_bump: u8,
    pub decimals: u8,
...
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Zeroable for CreateMintCpiIxArgs {}
#[cfg(feature = "cpi")]
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core_cpi::bytemuck::Pod for CreateMintCpiIxArgs {}

#[cfg(feature = "offchain")]
pub struct CreateMintAccounts {
...
pub fn build_create_mint<'a>(
    ...
    let mut ix_data = crate::sdk_core_offchain::vec![69, 44, 215, 132, 253, 214, 41, 45];
    let args = CreateMintIxArgs {
        id,
        mint_bump,
        launch_record_bump,
        decimals,
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.launch_record, is_signer: false, is_writable: false }, "launch_record")
...
#[cfg(feature = "cpi")]
pub trait CreateMintCpi<'info> {
    fn create_mint<'a>(
        &self,
        accounts: CreateMintCpiAccounts<'a>,
        id: u64,
        mint_bump: u8,
        launch_record_bump: u8,
        decimals: u8
    ) -> crate::sdk_core_cpi::Result<()> {
        self.create_mint_with_remaining_accounts(CreateMintCpiCall {
        accounts,
        id,
        mint_bump,
        launch_record_bump,
    ...
    fn create_mint_with_remaining_accounts<'a>(
        &self,
        call: CreateMintCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> CreateMintCpi<'info> for crate::sdk_core_cpi::Program<crate::TokenCreator> {
    fn create_mint_with_remaining_accounts<'a>(
        &self,
        call: CreateMintCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let CreateMintCpiCall { accounts, id, mint_bump, launch_record_bump, decimals, signer_seeds, remaining_accounts } = call;
        let args = CreateMintCpiIxArgs {
            id,
            mint_bump,
            launch_record_bump,
            decimals,
        ...
        ix_data.extend_from_slice(&[69, 44, 215, 132, 253, 214, 41, 45]);
        #[cfg(not(feature = "borsh"))]
        {
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::readonly(accounts.launch_record.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(accounts.launch_record);
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new_readonly(accounts.launch_record.address(), false),

...
unsafe impl crate::sdk_core::bytemuck::Zeroable for CreateMintIxArgs {}
#[cfg(not(feature = "borsh"))]
unsafe impl crate::sdk_core::bytemuck::Pod for CreateMintIxArgs {}
...
pub fn build_create_mint<'a>(
    ...
    let mut ix_data = crate::sdk_core::vec![69, 44, 215, 132, 253, 214, 41, 45];
    ...
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.launch_record, is_signer: false, is_writable: false }, "launchRecord")
...
pub struct CreateMintCpiAccounts<'a> {
    ...
    pub launch_record: crate::sdk_core::CpiHandle<'a>,
...
pub trait CreateMintCpi<'info> {
    fn create_mint<'a>(
        ...
        self.create_mint_with_remaining_accounts(accounts, id, mint_bump, launch_record_bump, decimals, &[], &[])
    }
    ...
    fn create_mint_signed<'a>(
        ...
        self.create_mint_with_remaining_accounts(accounts, id, mint_bump, launch_record_bump, decimals, signer_seeds, &[])
    }
...
#[cfg(feature = "cpi")]
impl<'info> CreateMintCpi<'info> for crate::sdk_core::Program<crate::TokenCreator> {
    fn create_mint_with_remaining_accounts<'a>(
        &self,
        accounts: CreateMintCpiAccounts<'a>,
        id: u64,
        ...
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core::pinocchio::instruction::InstructionAccount::readonly(accounts.launch_record.info.view.address()));
            idx += 1;

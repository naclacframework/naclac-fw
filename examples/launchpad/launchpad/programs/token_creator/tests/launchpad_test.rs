...
fn test_launchpad_integration() {
    ...
    println!("   ðŸª™ Created Quote Mint: {}", quote_mint_address);
    ...
    println!("   ðŸ’° Minted quote tokens to payer.");
    ...
    println!("   ðŸª™ Derived Token A Mint PDA: {}", mint_address);
    ...
    println!("   ðŸ“ Derived Launch Record PDA: {}", launch_record);
    ...
    println!("   âœ… Mint created on-chain!");
    ...
    println!("   ðŸš€ Created launcher vaults.");

    // 6. Execute launch_token CPI
    println!("ðŸ”¥ Sending launch_token transaction...");
    let decimals = 6u8;
    ...
    println!("   âœ… State verified successfully!");

    println!("\nâœ¨ Launchpad integration test completed successfully!\n");
}

...
fn test_fetcher_demo() {
    println!("\n=================== START RUST BORSH FETCHER TESTS ===================");
    ...
    let now = SystemTime::now()
        ...
        .unwrap()
        .as_secs();
    let vault_id1 = now % 100_000_000 + 3000;
    let vault_id2 = now % 100_000_000 + 4000;
    ...
    println!("\n--- fetch_borsh (Single UserAccount) ---");
    ...
    // --- fetch_multiple_borsh (Multiple) ---
    println!("\n--- fetch_multiple_borsh (Multiple Vaults) ---");
    ...
    // --- fetch_multiple_borsh_as_map (OOP Map Helper) ---
    println!("\n--- fetch_multiple_borsh_as_map (OOP Map Helper) ---");
    ...
    // --- fetch_all_borsh (All by program owner) ---
    println!("\n--- fetch_all_borsh (All Vaults) ---");
    ...
    println!("\n--- fetch_all_borsh (All UserAccounts) ---");

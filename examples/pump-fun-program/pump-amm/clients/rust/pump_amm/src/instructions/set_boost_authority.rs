...
pub struct SetBoostAuthorityAccounts {
    ...
    pub boost_authority: naclac_client::Address,
    pub system_program: naclac_client::Address,
}

#[cfg(feature = "offchain")]
pub fn build_set_boost_authority<'a>(
    provider: &'a naclac_client::NaclacProvider,
    program_id: naclac_client::Address,
    accounts: SetBoostAuthorityAccounts,
) -> naclac_client::InstructionBuilder<'a> {
    let ix_data = crate::sdk_core_offchain::vec![227, 149, 76, 42, 130, 39, 234, 205];
    naclac_client::InstructionBuilder::new(provider, program_id, ix_data)
        ...
        .account(naclac_client::AccountMeta { address: accounts.boost_authority, is_signer: false, is_writable: false }, "boost_authority")
        .account(naclac_client::AccountMeta { address: accounts.system_program, is_signer: false, is_writable: false }, "system_program")
}

#[cfg(feature = "cpi")]
pub struct SetBoostAuthorityCpiAccounts<'a> {
    pub admin: crate::sdk_core_cpi::CpiHandle<'a>,
    pub global_config: crate::sdk_core_cpi::CpiHandleMut<'a>,
    /// SAFETY: the new `boost_authority` value is this account's own
    /// address (real `set_boost_authority` takes zero args, matching this)
    /// — never deserialized, only its address is read.
    pub boost_authority: crate::sdk_core_cpi::CpiHandle<'a>,
    pub system_program: crate::sdk_core_cpi::CpiHandle<'a>,
}

#[cfg(feature = "cpi")]
pub struct SetBoostAuthorityCpiCall<'a> {
    pub accounts: SetBoostAuthorityCpiAccounts<'a>,
    pub signer_seeds: &'a [&'a [&'a [u8]]],
    pub remaining_accounts: &'a [(crate::sdk_core_cpi::AccountInfo, bool, bool)],
}

#[cfg(feature = "cpi")]
pub trait SetBoostAuthorityCpi<'info> {
    fn set_boost_authority<'a>(
        &self,
        accounts: SetBoostAuthorityCpiAccounts<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        self.set_boost_authority_with_remaining_accounts(SetBoostAuthorityCpiCall {
        accounts,
        signer_seeds: &[],
        remaining_accounts: &[],
    })
    ...
    fn set_boost_authority_signed<'a>(
        &self,
        accounts: SetBoostAuthorityCpiAccounts<'a>,
        signer_seeds: &[&[&[u8]]]
    ) -> crate::sdk_core_cpi::Result<()> {
    ...
    fn set_boost_authority_with_remaining_accounts<'a>(
        &self,
        call: SetBoostAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()>;

}

#[cfg(feature = "cpi")]
impl<'info> SetBoostAuthorityCpi<'info> for crate::sdk_core_cpi::Program<crate::PumpAmm> {
    fn set_boost_authority_with_remaining_accounts<'a>(
        &self,
        call: SetBoostAuthorityCpiCall<'a>
    ) -> crate::sdk_core_cpi::Result<()> {
        let SetBoostAuthorityCpiCall { accounts, signer_seeds, remaining_accounts } = call;
        let mut ix_data = crate::sdk_core_cpi::Vec::new();
        ix_data.extend_from_slice(&[227, 149, 76, 42, 130, 39, 234, 205]);
        #[cfg(feature = "pinocchio")]
        {
            ...
            idx += 1;
            metas_arr[idx].write(crate::sdk_core_cpi::pinocchio::instruction::InstructionAccount::readonly(accounts.boost_authority.info.view.address()));
            idx += 1;
            ...
            h_idx += 1;
            handles_arr[h_idx].write(accounts.boost_authority);
            h_idx += 1;
        ...
        #[cfg(not(feature = "pinocchio"))]
        {
            ...
            let mut account_metas = crate::sdk_core_cpi::vec![
                ...
                ::naclac_lang::solana_program::instruction::AccountMeta::new_readonly(accounts.boost_authority.address(), false),
